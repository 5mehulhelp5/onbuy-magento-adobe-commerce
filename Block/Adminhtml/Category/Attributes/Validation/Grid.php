...
class Grid extends \M2E\OnBuy\Block\Adminhtml\Magento\Grid\AbstractGrid
{
    ...
    private \M2E\OnBuy\Model\ResourceModel\Category\Dictionary $categoryResource;
    ...
    public function __construct(
        ...
        \M2E\OnBuy\Model\ResourceModel\Category\Dictionary $categoryResource,
    ...
    public function getMainButtonsHtml()
    {
        ...
        $button = $this->getLayout()->createBlock(
            ...
            'id' => 'onbuy_category_validation',
            'label' => __('Validate Attributes'),
            'onclick' => "OnBuyCategoryAttributeValidatorObj.reValidate('{$resetUrl}');",
    ...
    protected function _toHtml()
    {
        ...
        return $progressBarHtml . parent::_toHtml() . $this->getChildHtml('onbuy_validation');
    }
    ...
    protected function _prepareLayout()
    {
        ...
        $this->setChild(
            ...
            )->setTemplate('M2E_OnBuy::category/attributes/validation.phtml')
        );
    ...
    {
        return 'onbuy_category_attribute_validation_grid_modal';
    }

    public function getProgressBarSelectorId(): string
    {
        return 'onbuy_category_attribute_validation_progress_bar';
    }
}
