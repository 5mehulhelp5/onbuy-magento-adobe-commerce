...
namespace M2E\OnBuy\Block\Adminhtml\System\Config\Popup;

class ModuleControlPopup extends \M2E\OnBuy\Block\Adminhtml\Magento\AbstractBlock
{
    /** @var \M2E\OnBuy\Helper\Module */
    protected $moduleHelper;

    /**
     * @param \M2E\OnBuy\Block\Adminhtml\Magento\Context\Template $context
     * @param \M2E\OnBuy\Helper\Module $moduleHelper
     * @param array $data
     */
    ...
    protected function _toHtml(): string
    {
        ...
        if ($isModuleDisabled) {
            ...
            $confirmContent = __('<p>In case you confirm the Module disabling, the M2E OnBuy Connect ' .
                'dynamic tasks run by Cron will be stopped and the M2E OnBuy Connect Interface will be blocked.</p>' .
...
HTML;
    ...
    protected function _prepareLayout()
    {
        ...
        $this->js->addRequireJs(
            ...
            <<<JS
toggleOnBuyModuleStatus = function () {
