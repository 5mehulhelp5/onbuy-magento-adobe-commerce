...
use M2E\OnBuy\Model\Log\Clearing as LogClearing;

class LogsClearing extends \M2E\OnBuy\Block\Adminhtml\System\Config\Sections
{
    /** @var array */
    private $modes;
    /** @var array */
    private $days;
    private \M2E\OnBuy\Helper\Data $dataHelper;
    ...
    protected function _prepareForm()
    {
        ...
        $fieldSet = $form->addFieldset(
            ...
            [
                'legend' => __('M2E OnBuy Connect Listings Logs & Events Clearing'),
                'collapsable' => false,
            ]
        );
...
HTML
        ...
        $fieldSet->addField(
            ...
            [
                ...
                'class' => 'OnBuy-logs-clearing-interval',
                'required' => true,
                'tooltip' => __(
...
HTML
    ...
    protected function _prepareLayout(): void
    {
        ...
        $this->jsUrl->add($this->getUrl('m2e_onbuy/settings_logsClearing/save'), self::SECTION_ID_LOGS_CLEARING);
        $this->jsUrl->add($this->getUrl('m2e_onbuy/settings_logsClearing/save'), 'formSubmit');
