...
namespace M2E\OnBuy\Block\Adminhtml\System\Config\Sections\License;

class Create extends \M2E\OnBuy\Block\Adminhtml\System\Config\Sections
{
    ...
    protected function _prepareForm()
    {
        ...
        $fieldSet->addField(
            ...
            [
                ...
                'label' => __('Email'),
                'title' => __('Email'),
                'class' => 'OnBuy-validate-email validate-length maximum-length-80',
