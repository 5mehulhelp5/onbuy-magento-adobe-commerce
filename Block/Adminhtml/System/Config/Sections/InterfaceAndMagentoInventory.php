...
class InterfaceAndMagentoInventory extends \M2E\OnBuy\Block\Adminhtml\System\Config\Sections
{
    /** @var \M2E\OnBuy\Model\Module\Configuration */
    private $configurationHelper;
    private \M2E\OnBuy\Model\Product\InspectDirectChanges\Config $inspectDirectChangesConfig;

    public function __construct(
        \M2E\OnBuy\Model\Product\InspectDirectChanges\Config $inspectDirectChangesConfig,
        \M2E\OnBuy\Model\Module\Configuration $configurationHelper,
    ...
    protected function _prepareLayout()
    {
        ...
        $this->jsUrl->add(
            $this->getUrl('m2e_onbuy/settings_interfaceAndMagentoInventory/restoreRememberedChoices'),
