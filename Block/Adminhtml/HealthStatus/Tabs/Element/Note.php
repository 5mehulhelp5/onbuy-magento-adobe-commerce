...
namespace M2E\OnBuy\Block\Adminhtml\HealthStatus\Tabs\Element;

use Magento\Framework\Data\Form\Element\Note as OriginalNote;
use M2E\OnBuy\Model\HealthStatus\Task\Result;

/**
 * Class \M2E\OnBuy\Block\Adminhtml\HealthStatus\Tabs\Element\Note
 */
class Note extends OriginalNote
{
    /** @var \M2E\OnBuy\Model\HealthStatus\Task\Result */
    private $taskResult;
