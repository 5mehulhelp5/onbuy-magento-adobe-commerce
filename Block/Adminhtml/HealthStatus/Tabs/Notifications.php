...
namespace M2E\OnBuy\Block\Adminhtml\HealthStatus\Tabs;

use M2E\OnBuy\Model\HealthStatus\Notification\Settings;
use M2E\OnBuy\Model\HealthStatus\Task\Result;

class Notifications extends \M2E\OnBuy\Block\Adminhtml\Magento\Form\AbstractForm
{
    /** @var \Magento\Backend\Model\Auth */
    private $auth;
    /** @var \M2E\OnBuy\Model\HealthStatus\Notification\Settings */
    ...
    protected function _prepareForm()
    {
        ...
        $form->addField(
            ...
            self::HELP_BLOCK,
            [
                'content' => __('You can specify how M2E OnBuy Connect should notify you about Health Status of ' .
                    'your M2E OnBuy Connect by selecting: <ul>' .
                    '<li><b>Do Not Notify</b> - no notification required;</li>' .
                    '<li><b>On each Extension Page (default)</b> - notification will be shown on each ' .
                    'page of M2E OnBuy Connect Module;</li>' .
    ...
    protected function _beforeToHtml()
    {
        ...
        $this->jsPhp->addConstants(
            [
                '\M2E\OnBuy\Model\HealthStatus\Notification\Settings::MODE_EMAIL' => \M2E\OnBuy\Model\HealthStatus\Notification\Settings::MODE_EMAIL,
            ]
        );

        $this->js->addRequireJs(
            ['hS' => 'OnBuy/HealthStatus'],
            <<<JS
