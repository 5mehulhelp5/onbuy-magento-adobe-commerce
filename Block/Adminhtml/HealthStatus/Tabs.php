...
namespace M2E\OnBuy\Block\Adminhtml\HealthStatus;

use M2E\OnBuy\Model\HealthStatus\Task\IssueType;
use M2E\OnBuy\Model\HealthStatus\Task\InfoType;
...
class Tabs extends \M2E\OnBuy\Block\Adminhtml\Magento\Tabs\AbstractTabs
{
    ...
    /** @var \M2E\OnBuy\Model\HealthStatus\Task\Result\Set */
    private $resultSet;

    //########################################

    public function __construct(
        \M2E\OnBuy\Model\HealthStatus\Task\Result\Set $resultSet,
    ...
    protected function _prepareLayout()
    {
        ...
        /** @var \M2E\OnBuy\Block\Adminhtml\HealthStatus\Tabs\Dashboard $tabObj */
        $tabObj = $this->getLayout()->createBlock(
            \M2E\OnBuy\Block\Adminhtml\HealthStatus\Tabs\Dashboard::class,
            '',
            [
                'resultSet' => $resultSet,
            ]
        ...
        foreach ($this->resultSet->getByType(IssueType::TYPE) as $result) {
            ...
            /** @var \M2E\OnBuy\Block\Adminhtml\HealthStatus\Tabs\IssueGroup $tabObj */
            $tabObj = $this->getLayout()->createBlock(
                \M2E\OnBuy\Block\Adminhtml\HealthStatus\Tabs\IssueGroup::class,
                '',
                [
                    'resultSet' => $resultSet,
                ]
        ...
        // ---------------------------------------
        /** @var \M2E\OnBuy\Block\Adminhtml\HealthStatus\Tabs\Notifications $tabObj */
        $tabObj = $this->getLayout()->createBlock(
            \M2E\OnBuy\Block\Adminhtml\HealthStatus\Tabs\Notifications::class
        );
