...
use M2E\OnBuy\Model\Product as Listing_Product;
...
onchange="OnBuyVarienGridAction.execute(this, '{$itemId}');">
    <option value=""></option>
...
HTML;
    ...
    protected function _toLinkHtml($action, \Magento\Framework\DataObject $row)
    {
        ...
        $action['onclick'] = "OnBuyVarienGridAction.execute(this, '$itemId')";
