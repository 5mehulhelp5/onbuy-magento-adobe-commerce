...
namespace M2E\OnBuy\Block\Adminhtml\Magento\Payment;
...
class Info extends \Magento\Payment\Block\Info
{
    ...
    protected $_template = 'M2E_OnBuy::magento/order/payment/info.phtml';
    ...
    public function getPaymentMethod(): string
    {
        return (string)$this
            ->getInfo()
            ->getAdditionalInformation(OnBuyPayment::ADDITIONAL_DATA_KEY_PAYMENT_METHOD);
    }
    ...
    public function getChannelOrderId(): string
    {
        return (string)$this
            ->getInfo()
            ->getAdditionalInformation(OnBuyPayment::ADDITIONAL_DATA_KEY_CHANNEL_ORDER_ID);
    }
}
