...
namespace M2E\OnBuy\Block\Adminhtml\Magento\Tabs;

abstract class AbstractHorizontalStaticTabs extends \M2E\OnBuy\Block\Adminhtml\Magento\AbstractBlock
{
    ...
    protected $_template = 'M2E_OnBuy::magento/tabs/horizontal_static.phtml';
    ...
    protected function _toHtml()
    {
        ...
        if (!empty($styles)) {
            $this->css->add('.OnBuy-tabs-horizontal-static{ ' . $styles . ' }');
        }
