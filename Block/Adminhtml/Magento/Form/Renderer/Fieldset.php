...
class Fieldset extends MagentoFieldset
{
    ...
    {
        return <<<HTML
<div class="OnBuy-field-tooltip OnBuy-field-tooltip-{$directionClass}
OnBuy-fieldset-tooltip admin__field-tooltip">
...
HTML;
    ...
    {
        $element->addClass('OnBuy-fieldset');
        ...
        $element->addField(
            ...
            \M2E\OnBuy\Block\Adminhtml\Magento\Form\AbstractForm::HELP_BLOCK,
            [
                'content' => $tooltip,
                'tooltiped' => true,
            ],
