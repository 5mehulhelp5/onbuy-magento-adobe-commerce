...
namespace M2E\OnBuy\Block\Adminhtml\Magento\Product;

abstract class Grid extends \M2E\OnBuy\Block\Adminhtml\Magento\Grid\AbstractGrid
{
    ...
    public function setCollection($collection)
    {
        ...
        /** @var \M2E\OnBuy\Model\Magento\Product\Rule $ruleModel */
...
CSS
    ...
    public function getMassactionBlockHtml()
    {
        ...
        $advancedFilterBlock = $this
            ->getLayout()
            ->createBlock(\M2E\OnBuy\Block\Adminhtml\Listing\Product\Rule::class);
