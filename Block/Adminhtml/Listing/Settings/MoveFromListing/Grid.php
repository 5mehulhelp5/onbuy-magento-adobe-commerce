    ...
    protected function getHelpBlockHtml()
    {
        ...
        if ($this->canDisplayContainer()) {
            $helpBlockHtml = $this->getLayout()->createBlock(\M2E\OnBuy\Block\Adminhtml\HelpBlock::class)->setData(
                [
                    'content' => __('Item(s) can be moved to a Listing within the same OnBuy Account ' .
                        '.<br>You can select an existing M2E OnBuy Connect Listing or create a new one.<br><br>' .
