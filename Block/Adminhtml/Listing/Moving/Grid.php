...
namespace M2E\OnBuy\Block\Adminhtml\Listing\Moving;
...
class Grid extends \M2E\OnBuy\Block\Adminhtml\Magento\Grid\AbstractGrid
{
    ...
    protected function _prepareCollection()
    {
        ...
        $collection->addFieldToFilter(UnmanagedProductResource::COLUMN_SITE_ID, $this->siteId);
    ...
    public function callbackColumnActions($value, $row, $column, $isExport)
    {
        ...
        $url = $this->getUrl('m2e_onbuy/listing_wizard/createUnmanaged', ['listingId' => $listingId]);
    ...
    protected function getHelpBlockHtml()
    {
        ...
        if ($this->canDisplayContainer()) {
            $helpBlockHtml = $this->getLayout()->createBlock(\M2E\OnBuy\Block\Adminhtml\HelpBlock::class)->setData(
                [
                    'content' => __('Item(s) can be moved to a Listing within the same OnBuy Account.<br> ' .
                        'You can select an existing M2E OnBuy Connect Listing or create a new one.<br><br>' .
