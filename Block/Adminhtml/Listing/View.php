...
class View extends \M2E\OnBuy\Block\Adminhtml\Magento\Grid\AbstractContainer
{
    ...
    public function _construct()
    {
        ...
        /** @var \M2E\OnBuy\Block\Adminhtml\Listing\View\Switcher $viewModeSwitcher */
        $viewModeSwitcher = $this->getLayout()->createBlock(\M2E\OnBuy\Block\Adminhtml\Listing\View\Switcher::class);

        // Initialization block
        // ---------------------------------------
        $this->setId('onbuyListingView');
    ...
    protected function _prepareLayout()
    {
        $this->jsPhp->addConstants(
            [
                '\M2E\OnBuy\Block\Adminhtml\Log\Listing\Product\AbstractGrid::LISTING_PRODUCT_ID_FIELD' => AbstractGrid::LISTING_PRODUCT_ID_FIELD,
            ]
        );
        ...
        $url = $this->getUrl(
            '*/log_listing_product',
            [
                \M2E\OnBuy\Block\Adminhtml\Log\AbstractGrid::LISTING_ID_FIELD =>
        ...
        $this->addButton(
            ...
            [
                ...
                'class_name' => \M2E\OnBuy\Block\Adminhtml\Magento\Button\DropDown::class,
        ...
        $url = $this->getUrl(
            ...
            [
                ...
                'type' => \M2E\OnBuy\Model\Listing\Wizard::TYPE_GENERAL,
            ]
        );
    ...
    private function addGrid(): void
    {
        switch ($this->viewMode) {
            case \M2E\OnBuy\Block\Adminhtml\Listing\View\Switcher::VIEW_MODE_CHANNEL:
                $gridClass = \M2E\OnBuy\Block\Adminhtml\Listing\View\OnBuy\Grid::class;
                break;
            case \M2E\OnBuy\Block\Adminhtml\Listing\View\Switcher::VIEW_MODE_MAGENTO:
                $gridClass = \M2E\OnBuy\Block\Adminhtml\Listing\View\Magento\Grid::class;
                break;
            case \M2E\OnBuy\Block\Adminhtml\Listing\View\Switcher::VIEW_MODE_SETTINGS:
                $gridClass = \M2E\OnBuy\Block\Adminhtml\Listing\View\Settings\Grid::class;
                break;
            default:
                throw new \M2E\OnBuy\Model\Exception\Logic(sprintf('Unknown view mode - %s', $this->viewMode));
        }
