...
namespace M2E\OnBuy\Block\Adminhtml\Listing\Mapping;
...
class View extends \M2E\OnBuy\Block\Adminhtml\Magento\Grid\AbstractContainer
{
    ...
    {
        $helpBlock = $this->getLayout()->createBlock(\M2E\OnBuy\Block\Adminhtml\HelpBlock::class)->addData(
            [
        ...
        /** @var \M2E\OnBuy\Block\Adminhtml\Listing\Mapping\Grid $block */
