...
namespace M2E\OnBuy\Block\Adminhtml\Listing\Template\NewTemplate;
...
class Form extends \M2E\OnBuy\Block\Adminhtml\Magento\Form\AbstractForm
{
    protected function _prepareForm()
    {
        if ($this->getData('nick') == '') {
            throw new \M2E\OnBuy\Model\Exception\Logic('You should set template "nick"');
        }
        ...
        $form->addField(
            ...
            [
                'content' => __(
                    ...
                    'search for it in case you need to use it in a different M2E OnBuy Connect Listing ' .
        ...
        $fieldset->addField(
            ...
            [
                ...
                'class' => 'OnBuy-validate-template-title',
                'label' => __('Title'),
