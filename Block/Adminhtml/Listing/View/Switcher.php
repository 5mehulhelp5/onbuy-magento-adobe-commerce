...
{
    public const VIEW_MODE_CHANNEL = 'onBuy';
    ...
    protected \M2E\OnBuy\Helper\Data\Session $sessionDataHelper;
    ...
    public function getTooltip(): string
    {
        return (string)__('<p>There are several <strong>View Modes</strong> available to you:</p>' .
            '<ul><li><p><strong>OnBuy</strong> - displays Product details with respect to OnBuy ' .
            'Item information. Using this Mode, you can easily filter down the list of Products based on OnBuy ' .
            'Item details as well as perform Actions to OnBuy Items in bulk ' .
            ...
            '(i.e. Selling Settings, OnBuy Categories, etc). Using this Mode, you can easily find Products ' .
    ...
    public function getDefaultParam()
    {
        $sessionViewMode = $this->sessionDataHelper->getValue(
            "OnBuy_listing_{$this->getListing()->getId()}_view_mode"
        );
