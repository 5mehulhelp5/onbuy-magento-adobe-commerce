...
class CategorySelectMode extends \M2E\OnBuy\Block\Adminhtml\Magento\Form\AbstractContainer
{
    use WizardTrait;
    ...
    {
        $this->addChild('form', \M2E\OnBuy\Block\Adminhtml\Listing\Wizard\Category\ModeSame\Form::class);
