...
namespace M2E\OnBuy\Block\Adminhtml\Listing\Wizard\Category\ModeManually;

use M2E\OnBuy\Block\Adminhtml\Order\Grid\Column\Filter\CategoryMode as CategoryModeFilter;
use M2E\OnBuy\Model\ResourceModel\Listing\Wizard\Step as StepResource;
...
class Grid extends \M2E\OnBuy\Block\Adminhtml\Magento\Grid\AbstractGrid
{
    ...
    private \M2E\OnBuy\Model\ResourceModel\Listing\Wizard\Product $productResource;
    ...
    public function __construct(
        ...
        \M2E\OnBuy\Model\ResourceModel\Listing\Wizard\Product $productResource,
    ...
    protected function _prepareCollection()
    {
        ...
        $collection->joinTable(
            ...
            [
                'product_id' => \M2E\OnBuy\Model\ResourceModel\Listing\Wizard\Product::COLUMN_ID,
            ],
            sprintf(
                '{{table}}.%s = %s',
...
require([
    ...
    'OnBuy/Listing/Wizard/Category/Mode/Manually/Grid'
], function(){
