...
namespace M2E\OnBuy\Block\Adminhtml\Listing\Wizard\Category\Add\Summary;

class Grid extends \M2E\OnBuy\Block\Adminhtml\Category\Grid
{
    /** @var \M2E\OnBuy\Helper\Module\Database\Structure */
    private $databaseHelper;

    public function __construct(
        \M2E\OnBuy\Model\ResourceModel\Magento\Category\CollectionFactory $categoryCollectionFactory,
...
HTML;
        ...
        $help = $this->getLayout()->createBlock(\M2E\OnBuy\Block\Adminhtml\HelpBlock::class)->setData([
...
HTML;
        ...
        if (!$this->getRequest()->getParam('grid')) {
            $this->js->add(
                <<<JS
    require([
        'OnBuy/Listing/Wizard/Product/Summary/Grid'
    ],function() {
