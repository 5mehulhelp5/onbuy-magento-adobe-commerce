...
class Add extends \M2E\OnBuy\Block\Adminhtml\Magento\Grid\AbstractContainer
{
    ...
    private function addGrid(): void
    {
        switch ($this->sourceMode) {
            case \M2E\OnBuy\Block\Adminhtml\Listing\Wizard\ProductSourceSelect::MODE_PRODUCT:
                $gridClass = \M2E\OnBuy\Block\Adminhtml\Listing\Wizard\Product\Add\Grid::class;
                break;

            case \M2E\OnBuy\Block\Adminhtml\Listing\Wizard\ProductSourceSelect::MODE_CATEGORY:
                $gridClass = \M2E\OnBuy\Block\Adminhtml\Listing\Wizard\Product\Add\Category\Grid::class;
                break;

            default:
                throw new \M2E\OnBuy\Model\Exception\Logic(sprintf('Unknown source mode - %s', $this->sourceMode));
        }
    ...
    private function getAutoactionPopupHtml()
    {
        $message = __('<h3>Do you want to set up a Rule by which Products will be automatically ' .
            'Added or Deleted from the current M2E OnBuy Connect Listing?</h3> Click <b>Start Configure</b> ' .
