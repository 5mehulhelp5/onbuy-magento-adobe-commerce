...
class SearchChannelIdStep extends \M2E\OnBuy\Block\Adminhtml\Magento\Grid\AbstractContainer
{
    ...
    public function _construct(): void
    {
        ...
        $this->setId('SearchOPCForListingProducts');
        ...
        $this->prepareButtons(
            [
                ...
                'data_attribute' => [
                    'mage-init' => [
                        'OnBuy/Listing/Wizard/Product/Search/ContinueProcessor' => [
    ...
    protected function _prepareLayout()
    {
        ...
        /** @var \M2E\OnBuy\Block\Adminhtml\Listing\Wizard\Product\SearchChannelIdStep\Grid $grid */
