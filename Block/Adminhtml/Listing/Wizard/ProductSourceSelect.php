...
class ProductSourceSelect extends \M2E\OnBuy\Block\Adminhtml\Magento\Form\AbstractContainer
{
    use WizardTrait;
    ...
    {
        $this->addChild('form', \M2E\OnBuy\Block\Adminhtml\Listing\Wizard\ProductSource\Form::class);
