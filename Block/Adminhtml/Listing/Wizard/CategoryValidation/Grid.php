...
namespace M2E\OnBuy\Block\Adminhtml\Listing\Wizard\CategoryValidation;
...
class Grid extends \M2E\OnBuy\Block\Adminhtml\Magento\Grid\AbstractGrid
{
    ...
    protected function _prepareLayout()
    {
        ...
        $this->setChild(
            ...
            )->setTemplate('M2E_OnBuy::listing/wizard/category/attributes/validation.phtml')
        );
    ...
    {
        return 'onbuy_category_attribute_validation_grid';
    }
