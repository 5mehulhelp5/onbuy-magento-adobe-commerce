...
use M2E\OnBuy\Model\Listing\Wizard\Ui\RuntimeStorage as WizardRuntimeStorage;
use M2E\OnBuy\Model\Listing\Ui\RuntimeStorage as ListingRuntimeStorage;
use M2E\OnBuy\Block\Adminhtml\Magento\Context\Widget;
...
class View extends AbstractContainer
{
    ...
    {
        parent::_construct();
        $this->setId('onbuyListingAttributesValidation');
    ...
    protected function _prepareLayout()
    {
        ...
        $headerBlock = $this
            ->getLayout()
            ->createBlock(\M2E\OnBuy\Block\Adminhtml\Listing\View\Header::class, '', [
