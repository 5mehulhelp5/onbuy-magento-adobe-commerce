...
use M2E\OnBuy\Model\ResourceModel\Listing\Wizard\Product as WiardProductResource;
...
{
    protected \M2E\OnBuy\Helper\Magento\Product $magentoProductHelper;
    ...
    private \M2E\OnBuy\Model\ResourceModel\Listing\Wizard $wizardResource;
    private \M2E\OnBuy\Model\ResourceModel\Listing\Wizard\Product $listingWizardProductResource;
    ...
    public function __construct(
        ...
        \M2E\OnBuy\Model\ResourceModel\Listing\Wizard $wizardResource,
        \M2E\OnBuy\Model\ResourceModel\Listing\Wizard\Product $listingWizardProductResource,
    ...
    public function _construct()
    {
        ...
        // ---------------------------------------
        $this->setId('onbuyListingProductGrid' . $this->getListing()->getId());
        // ---------------------------------------
    ...
    protected function _prepareColumns()
    {
        ...
        $this->addColumn('price', [
            ...
            'width' => '100px',
            'type' => 'price',
            'filter' => \M2E\OnBuy\Block\Adminhtml\Magento\Grid\Column\Filter\Price::class,
...
JS,
        ...
        $this->js->add(
            <<<JS
    require([
        'OnBuy/Listing/Wizard/Product/Add',
...
JS,
    ...
    private function getListing(): \M2E\OnBuy\Model\Listing
    {
    ...
    private function skipProductsFromOthersListings(
        ...
        $productsInListingQuery->where('`listing`.`site_id` = ?', $this->getListing()->getSiteId());
