...
trait BlockTrait
{
    ...
    {
        $directionToRightClass = $directionToRight ? 'OnBuy-field-tooltip-right' : '';

        return <<<HTML
<div class="OnBuy-field-tooltip admin__field-tooltip {$directionToRightClass}">
...
HTML;
    ...
    {
        return $this->getLayout()->addBlock(\M2E\OnBuy\Block\Adminhtml\HelpBlock::class, '', 'main.top')
                    ->setData(
                        $data,
                    );
    }
