...
namespace M2E\OnBuy\Block\Adminhtml\Mapping\Tabs;

class AttributeMapping extends \M2E\OnBuy\Block\Adminhtml\Magento\Form\AbstractForm
{
    ...
    protected function _beforeToHtml()
    {
        $this->jsUrl->add(
            ...
            \M2E\OnBuy\Block\Adminhtml\Mapping\Tabs::TAB_ID_MAPPING_ATTRIBUTES
        );
