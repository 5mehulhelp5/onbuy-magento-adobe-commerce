...
abstract class AbstractGrid extends \M2E\OnBuy\Block\Adminhtml\Magento\Grid\AbstractGrid
{
    ...
    /** @var \M2E\OnBuy\Model\Product $listingProduct */
    protected $listingProduct = null;

    protected $messageCount = [];
    protected $entityIdFieldName;
    protected $logModelName;
    /** @var \M2E\OnBuy\Helper\View */
    ...
    {
        return [
            \M2E\OnBuy\Model\Log\AbstractModel::TYPE_INFO => (string)__('Info'),
            \M2E\OnBuy\Model\Log\AbstractModel::TYPE_SUCCESS => (string)__('Success'),
    ...
    public function callbackColumnType($value, $row, $column, $isExport)
    {
        switch ($row->getData('type')) {
            case \M2E\OnBuy\Model\Log\AbstractModel::TYPE_SUCCESS:
                $value = '<span style="color: green;">' . $value . '</span>';
                break;

            case \M2E\OnBuy\Model\Log\AbstractModel::TYPE_WARNING:
                $value = '<span style="color: orange; font-weight: bold;">' . $value . '</span>';
                break;

            case \M2E\OnBuy\Model\Synchronization\Log::TYPE_FATAL_ERROR:
            case \M2E\OnBuy\Model\Log\AbstractModel::TYPE_ERROR:
...
HTML;
        ...
        if (isset($this->messageCount[$row[$this->entityIdFieldName]])) {
            $colorMap = [
                \M2E\OnBuy\Model\Log\AbstractModel::TYPE_INFO => 'gray',
                \M2E\OnBuy\Model\Log\AbstractModel::TYPE_SUCCESS => 'green',
                \M2E\OnBuy\Model\Log\AbstractModel::TYPE_WARNING => 'orange',
                \M2E\OnBuy\Model\Log\AbstractModel::TYPE_ERROR => 'red',
            ];
    ...
    protected function _toHtml()
    {
        ...
        $this->js->addRequireJs(['l' => 'OnBuy/Log'], "window.LogObj = new Log();");
