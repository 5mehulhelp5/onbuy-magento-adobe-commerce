...
namespace M2E\OnBuy\Block\Adminhtml\Log\Listing\View;
...
class Switcher extends \M2E\OnBuy\Block\Adminhtml\Switcher
{
    ...
    /** @var \M2E\OnBuy\Helper\Data\Session */
    private $dataSessionHelper;

    public function __construct(
        \M2E\OnBuy\Helper\Data\Session $dataSessionHelper,
    ...
    {
        $sessionViewMode = $this->dataSessionHelper->getValue('onbuy_log_listing_view_mode');
    ...
    public function getSelectedParam()
    {
        ...
        $this->dataSessionHelper->setValue('onbuy_log_listing_view_mode', $selectedViewMode);
