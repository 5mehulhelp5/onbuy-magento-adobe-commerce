...
namespace M2E\OnBuy\Block\Adminhtml\Log\Listing\Product;

abstract class AbstractView extends \M2E\OnBuy\Block\Adminhtml\Log\Listing\AbstractView
{
    ...
    {
        $sessionViewMode = $this->sessionDataHelper->getValue('onbuy_log_listing_view_mode');

        $uniqueMessageFilterBlockHtml = '';
        if ($sessionViewMode === \M2E\OnBuy\Block\Adminhtml\Log\Listing\View\Switcher::VIEW_MODE_SEPARATED) {
    ...
    {
        return $this->getRequest()->getParam(
            \M2E\OnBuy\Block\Adminhtml\Log\AbstractGrid::LISTING_PRODUCT_ID_FIELD,
            false
        );
    }
