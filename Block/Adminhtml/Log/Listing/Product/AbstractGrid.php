...
abstract class AbstractGrid extends \M2E\OnBuy\Block\Adminhtml\Log\Listing\AbstractGrid
{
    ...
    /**
     * @param \M2E\OnBuy\Model\Listing\Log|\Magento\Framework\DataObject $type DataObject for grouped mode
     *
     * @return int
     */
    ...
    {
        $allActions = \M2E\OnBuy\Helper\Module\Log::getActionsTitlesByClass(
            \M2E\OnBuy\Model\Listing\Log::class,
        );
