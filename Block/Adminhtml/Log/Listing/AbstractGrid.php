...
abstract class AbstractGrid extends \M2E\OnBuy\Block\Adminhtml\Log\AbstractGrid
{
    /** @var \M2E\OnBuy\Model\ResourceModel\Collection\WrapperFactory */
    ...
    protected function addMaxAllowedLogsCountExceededNotification($date)
    {
        ...
        $this->js->add("OnBuy.formData.maxAllowedLogsCountExceededNotification = '{$notification}';");
    }
