...
class General extends Magento\AbstractBlock
{
    ...
    public \M2E\OnBuy\Helper\View $viewHelper;
    private \M2E\OnBuy\Model\Module\Configuration $configuration;

    public function __construct(
        \M2E\OnBuy\Helper\View $viewHelper,
        \M2E\OnBuy\Block\Adminhtml\Magento\Context\Template $context,
        \M2E\OnBuy\Model\Module\Configuration $configuration,
        array $data = []
    ) {
    ...
    protected function _beforeToHtml()
    {
        ...
        $this->jsUrl->addUrls([
            'onbuy_skin_url' => $this->getViewFileUrl('M2E_OnBuy'),
            'general/getCreateAttributeHtmlPopup' => $this->getUrl('*/general/getCreateAttributeHtmlPopup'),
        ]);
