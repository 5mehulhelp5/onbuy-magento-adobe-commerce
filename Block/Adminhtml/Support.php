...
class Support extends \M2E\OnBuy\Block\Adminhtml\Magento\AbstractBlock
{
    private \M2E\OnBuy\Helper\Module\Support $moduleSupportHelper;

    public function __construct(
        \M2E\OnBuy\Helper\Module\Support $moduleSupportHelper,
    ...
    protected function _prepareLayout()
    {
        $this->appendHelpBlock([
            ...
            'no_hide' => true,
            'content' => __(
                '<p>Have any questions regarding the use of M2E OnBuy Connect, its functionality, ' .
                ...
                'for M2E OnBuy Connect clients. There is also a ' .
                ...
                'available resources, feel free to reach out to M2E OnBuy Connect Support Team by clicking ' .
                ...
                'https://docs-m2.m2epro.com',
                'https://help.m2epro.com/en/support/solutions/9000117126',
                'https://www.youtube.com/watch?v=tka24gn22oQ'
            ),
        ]);
...
<div class="a-center">
    <input id="contact_us_button"
        value="Contact Us"
        class="action-primary OnBuy-field-without-tooltip"
        type="button"
