...
use M2E\OnBuy\Model\Listing\Log;
use M2E\OnBuy\Model\ResourceModel\Listing\Log as ListingLogResource;
...
class Listing extends \Magento\Backend\Block\Widget\Grid\Column\Renderer\Text
{
    ...
    public function render(\Magento\Framework\DataObject $row)
    {
        ...
        $dbSelect = $connection->select()
                               ...
                               ->order(['id DESC'])
                               ->limit(\M2E\OnBuy\Block\Adminhtml\Log\Grid\LastActions::PRODUCTS_LIMIT);
    ...
    {
        $summary = $this->getLayout()->createBlock(\M2E\OnBuy\Block\Adminhtml\Listing\Log\Grid\LastActions::class)
                        ->setData([
