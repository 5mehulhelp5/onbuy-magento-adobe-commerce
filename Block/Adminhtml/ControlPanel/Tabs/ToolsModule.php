...
/**
 * Class \M2E\OnBuy\Block\Adminhtml\ControlPanel\Tabs\ToolsModule
 */
class ToolsModule extends AbstractBlock
{
    ...
    protected function _beforeToHtml()
    {
        $this->setChild(
            'tabs',
            $this->getLayout()->createBlock(\M2E\OnBuy\Block\Adminhtml\ControlPanel\Tabs\ToolsModule\Tabs::class)
        );
