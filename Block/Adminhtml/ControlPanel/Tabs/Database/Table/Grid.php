...
namespace M2E\OnBuy\Block\Adminhtml\ControlPanel\Tabs\Database\Table;

use M2E\OnBuy\Block\Adminhtml\ControlPanel\Tabs\Database\Table\Column\Filter\Select as SelectFilter;
...
class Grid extends AbstractGrid
{
    ...
    /** @var  \M2E\OnBuy\Model\ControlPanel\Database\TableModel */
    private $tableModel;
    ...
    {
        /**
         * @var \M2E\OnBuy\Model\ResourceModel\Listing\Log\Collection $collection
         */
    ...
    protected function _prepareColumns()
    {
        foreach ($this->getTableModel()->getColumns() as $column) {
            ...
            if ($this->getColumnType($column) === 'datetime') {
                ...
                $params['filter'] = \M2E\OnBuy\Block\Adminhtml\Magento\Grid\Column\Filter\Datetime::class;
            }
            ...
            if (
                ...
                $columnData = [
                    ...
                    'filter' => \M2E\OnBuy\Block\Adminhtml\Magento\Grid\Column\Filter\Range::class,
                    'sortable' => true,
    ...
    protected function _beforeToHtml()
    {
        ...
        $this->js->addRequireJs(
            [
                'jQuery' => 'jquery',
                'l' => 'OnBuy/ControlPanel/Database/Grid',
            ],
            <<<JS
...
HTML;
    ...
    /**
     * @param \M2E\OnBuy\Model\ResourceModel\OperationHistory\Collection $collection
    ...
    public function getTableModel(): \M2E\OnBuy\Model\ControlPanel\Database\TableModel
    {
