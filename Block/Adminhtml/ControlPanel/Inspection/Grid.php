...
use M2E\OnBuy\Block\Adminhtml\Magento\Grid\AbstractGrid as WidgetAbstractGrid;
use M2E\OnBuy\Model\ResourceModel\Collection\Custom;
...
class Grid extends WidgetAbstractGrid
{
    ...
    /** @var \M2E\OnBuy\Model\ResourceModel\Collection\CustomFactory */
    protected $customCollectionFactory;

    /** @var ObjectManagerInterface */
    protected $objectManager;

    /** @var \M2E\OnBuy\Model\ControlPanel\Inspection\Repository $repository */
    private $repository;
...
{$value}
<div class="OnBuy-field-tooltip-to-right admin__field-tooltip">
...
HTML;
    ...
    protected function _beforeToHtml()
    {
        ...
        $this->js->addOnReadyJs(
            <<<JS
require(['domReady', 'OnBuy/ControlPanel/Inspection'], function() {
