...
namespace M2E\OnBuy\Block\Adminhtml\Template\Category\Chooser;

class Tabs extends \M2E\OnBuy\Block\Adminhtml\Magento\Tabs\AbstractHorizontalTabs
{
    ...
    {
        parent::_construct();
        $this->setId('onBuyTemplateCategoryChooserTabs');
    ...
    protected function _prepareLayout()
    {
        $recentContent = $this->getLayout()->createBlock(
            \M2E\OnBuy\Block\Adminhtml\Template\Category\Chooser\Tabs\Recent::class,
        )->toHtml();
        ...
        $browseContent = $this->getLayout()->createBlock(
            \M2E\OnBuy\Block\Adminhtml\Template\Category\Chooser\Tabs\Browse::class,
        )->toHtml();
        ...
        $searchContent = $this->getLayout()->createBlock(
            \M2E\OnBuy\Block\Adminhtml\Category\Chooser\Tab\Search::class,
        )->toHtml();
