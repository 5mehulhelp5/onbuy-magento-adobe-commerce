...
class Edit extends \M2E\OnBuy\Block\Adminhtml\Magento\AbstractContainer
{
    ...
    public function _construct()
    {
        ...
        $this->setId('onBuyTemplateCategoryChooserEdit');
    ...
    private function renderWithTabs(): string
    {
        $tabsContainer = $this->getLayout()->createBlock(
            \M2E\OnBuy\Block\Adminhtml\Template\Category\Chooser\Tabs::class,
        );
