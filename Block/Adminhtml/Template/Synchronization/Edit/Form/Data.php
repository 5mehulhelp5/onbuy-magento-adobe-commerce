...
class Data extends AbstractBlock
{
    ...
    protected function _prepareLayout()
    {
        ...
        $this->setChild(
            ...
            $this->getLayout()
                 ->createBlock(
                     \M2E\OnBuy\Block\Adminhtml\Template\Synchronization\Edit\Form\Tabs::class
                 )
        );

        $this->jsPhp->addConstants(
            [
                '\M2E\OnBuy\Model\Policy\Synchronization::QTY_MODE_NONE' => \M2E\OnBuy\Model\Policy\Synchronization::QTY_MODE_NONE,
                '\M2E\OnBuy\Model\Policy\Synchronization::QTY_MODE_YES' => \M2E\OnBuy\Model\Policy\Synchronization::QTY_MODE_YES,
            ]
        );
...
CSS
        ...
        $this->js->add(
            <<<JS
    require([
        'OnBuy/Template/Synchronization'
    ], function(){
        window.OnBuyTemplateSynchronizationObj = new OnBuyTemplateSynchronization();
        OnBuyTemplateSynchronizationObj.initObservers();
    });
JS
        );
