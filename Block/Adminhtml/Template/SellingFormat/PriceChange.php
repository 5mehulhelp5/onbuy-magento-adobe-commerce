...
namespace M2E\OnBuy\Block\Adminhtml\Template\SellingFormat;

class PriceChange extends \M2E\OnBuy\Block\Adminhtml\Magento\AbstractBlock
{
    /** @var string */
    ...
    public function getPriceModifierAttributes(string $priceModifierString): array
    {
        ...
        foreach ($priceModifier as $modification) {
            if (
                $modification['mode'] == \M2E\OnBuy\Model\Policy\SellingFormat::PRICE_MODIFIER_ATTRIBUTE
