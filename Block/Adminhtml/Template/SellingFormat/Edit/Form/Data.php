...
namespace M2E\OnBuy\Block\Adminhtml\Template\SellingFormat\Edit\Form;
...
class Data extends AbstractForm
{
    ...
    /** @var \M2E\OnBuy\Model\Policy\SellingFormat\BuilderFactory */
    private SellingFormat\BuilderFactory $templateSellingFormatBuilderFactory;

    public function __construct(
        \M2E\OnBuy\Model\Policy\SellingFormat\BuilderFactory $templateSellingFormatBuilderFactory,
    ...
    {
        $attributes = $this->globalDataHelper->getValue('onbuy_attributes');
        ...
        $fieldset->addField(
            ...
            [
                ...
                'value' => $formData['qty_mode'] != \M2E\OnBuy\Model\Policy\SellingFormat::QTY_MODE_ATTRIBUTE
                    ? $formData['qty_mode'] : '',
                'create_magento_attribute' => true,
                'tooltip' => __('The number of Items you want to sell on OnBuy.<br/><br/>' .
                    '<b>Product Quantity:</b> the number of Items on OnBuy will be the same as in Magento.<br/>' .
        ...
        $fieldset->addField(
            ...
            [
                ...
                'tooltip' => __('Sets the percentage for calculation of Items number to be Listed ' .
                    'on OnBuy basing on Product Quantity or Magento Attribute. E.g., if Quantity Percentage ' .
                    'is set to 10% and Product Quantity is 100, the Quantity to be Listed on OnBuy will ' .
        ...
        $fieldset->addField(
            ...
            [
                ...
                'tooltip' => __('Choose whether to limit the amount of Stock you list on OnBuy, eg ' .
                    'because you want to set some Stock aside for sales off OnBuy.<br/><br/>If this Setting ' .
                    'is <b>Enabled</b> you can specify the maximum Quantity to be Listed. If this Setting ' .
                    'is <b>Disabled</b> all Stock for the Product will be Listed as available on OnBuy.'),
            ]
        );
        ...
        $fieldset->addField(
            ...
            [
                ...
                'class' => 'OnBuy-validate-qty',
                'required' => true,
                'tooltip' => __('If you have 2 pieces in Stock but set a Minimum Quantity to Be Listed of 5, ' .
                    'Item will not be Listed on OnBuy.<br/> Otherwise, the Item will be Listed with ' .
        ...
        $fieldset->addField(
            ...
            [
                ...
                'class' => 'OnBuy-validate-qty',
                'required' => true,
                'tooltip' => __('Set a maximum number to sell on OnBuy, e.g. if you ' .
        ...
        $fieldset->addField(
            ...
            [
                ...
                'css_class' => 'OnBuy-fieldset-table',
            ]
        );
        ...
        $this->jsPhp->addConstants(
            [
                '\M2E\OnBuy\Model\Policy\SellingFormat::QTY_MODE_PRODUCT' => \M2E\OnBuy\Model\Policy\SellingFormat::QTY_MODE_PRODUCT,
                '\M2E\OnBuy\Model\Policy\SellingFormat::QTY_MODE_NUMBER' => \M2E\OnBuy\Model\Policy\SellingFormat::QTY_MODE_NUMBER,
                '\M2E\OnBuy\Model\Policy\SellingFormat::QTY_MODE_ATTRIBUTE' => \M2E\OnBuy\Model\Policy\SellingFormat::QTY_MODE_ATTRIBUTE,
                '\M2E\OnBuy\Model\Policy\SellingFormat::QTY_MODE_PRODUCT_FIXED' => \M2E\OnBuy\Model\Policy\SellingFormat::QTY_MODE_PRODUCT_FIXED,
                '\M2E\OnBuy\Model\Policy\SellingFormat::PRICE_MODE_ATTRIBUTE' => \M2E\OnBuy\Model\Policy\SellingFormat::PRICE_MODE_ATTRIBUTE,
                '\M2E\OnBuy\Model\Policy\SellingFormat::PRICE_MODIFIER_ABSOLUTE_INCREASE' => \M2E\OnBuy\Model\Policy\SellingFormat::PRICE_MODIFIER_ABSOLUTE_INCREASE,
                '\M2E\OnBuy\Model\Policy\SellingFormat::PRICE_MODIFIER_ABSOLUTE_DECREASE' => \M2E\OnBuy\Model\Policy\SellingFormat::PRICE_MODIFIER_ABSOLUTE_DECREASE,
                '\M2E\OnBuy\Model\Policy\SellingFormat::PRICE_MODIFIER_PERCENTAGE_INCREASE' => \M2E\OnBuy\Model\Policy\SellingFormat::PRICE_MODIFIER_PERCENTAGE_INCREASE,
                '\M2E\OnBuy\Model\Policy\SellingFormat::PRICE_MODIFIER_PERCENTAGE_DECREASE' => \M2E\OnBuy\Model\Policy\SellingFormat::PRICE_MODIFIER_PERCENTAGE_DECREASE,
                '\M2E\OnBuy\Model\Policy\SellingFormat::PRICE_MODIFIER_ATTRIBUTE' => \M2E\OnBuy\Model\Policy\SellingFormat::PRICE_MODIFIER_ATTRIBUTE,
                '\M2E\OnBuy\Model\Policy\SellingFormat::PRICE_COEFFICIENT_ABSOLUTE_INCREASE' => \M2E\OnBuy\Model\Policy\SellingFormat::PRICE_COEFFICIENT_ABSOLUTE_INCREASE,
                '\M2E\OnBuy\Model\Policy\SellingFormat::PRICE_COEFFICIENT_PERCENTAGE_INCREASE' => \M2E\OnBuy\Model\Policy\SellingFormat::PRICE_COEFFICIENT_PERCENTAGE_INCREASE,
                '\M2E\OnBuy\Model\Policy\SellingFormat::PRICE_COEFFICIENT_PERCENTAGE_DECREASE' => \M2E\OnBuy\Model\Policy\SellingFormat::PRICE_COEFFICIENT_PERCENTAGE_DECREASE,
                '\M2E\OnBuy\Model\Policy\SellingFormat::PRICE_COEFFICIENT_ATTRIBUTE' => \M2E\OnBuy\Model\Policy\SellingFormat::PRICE_COEFFICIENT_ATTRIBUTE,
                '\M2E\OnBuy\Model\Policy\SellingFormat::QTY_MODIFICATION_MODE_ON' => \M2E\OnBuy\Model\Policy\SellingFormat::QTY_MODIFICATION_MODE_ON,
                '\M2E\OnBuy\Model\Policy\SellingFormat::QTY_MODIFICATION_MODE_OFF' => \M2E\OnBuy\Model\Policy\SellingFormat::QTY_MODIFICATION_MODE_OFF,
                '\M2E\OnBuy\Model\Policy\SellingFormat::PRICE_COEFFICIENT_ABSOLUTE_DECREASE' => \M2E\OnBuy\Model\Policy\SellingFormat::PRICE_COEFFICIENT_ABSOLUTE_DECREASE,
                '\M2E\OnBuy\Model\Policy\SellingFormat::PRICE_COEFFICIENT_NONE' => \M2E\OnBuy\Model\Policy\SellingFormat::PRICE_COEFFICIENT_NONE,
            ]
        );
        ...
        $this->js->add("OnBuy.formData.qty_mode = $jsMode;");
        $this->js->add("OnBuy.formData.qty_modification_mode = $jsQty;");
    ...
    OnBuyTemplateSellingFormatObj.renderFixedPriceChangeRows({$formDataJson});
JS;
        }
        ...
        $this->js->add(
            <<<JS
    require([
        'OnBuy/Template/SellingFormat',
    ], function(){
        window.OnBuyTemplateSellingFormatObj = new OnBuyTemplateSellingFormat();
        OnBuyTemplateSellingFormatObj.initObservers();
...
JS
    ...
    {
        $template = $this->globalDataHelper->getValue('onbuy_template_selling_format');
    ...
    private function getPriceTableHtml(): string
    {
        $block = $this->getLayout()->createBlock(
            \M2E\OnBuy\Block\Adminhtml\Template\SellingFormat\Edit\Form\PriceTable::class
        );
        $block->addData([
