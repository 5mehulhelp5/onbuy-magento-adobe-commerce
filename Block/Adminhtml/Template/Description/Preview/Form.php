...
namespace M2E\OnBuy\Block\Adminhtml\Template\Description\Preview;
...
class Form extends AbstractForm
{
    protected function _prepareForm()
    {
        ...
        $viewButton = $this->getLayout()->createBlock(\M2E\OnBuy\Block\Adminhtml\Magento\Button::class);
        $viewButton->addData([
            'label' => __('View'),
            'type' => 'submit',
        ]);

        $randomButton = $this->getLayout()->createBlock(\M2E\OnBuy\Block\Adminhtml\Magento\Button::class);
