...
namespace M2E\OnBuy\Block\Adminhtml\Template\Description\Edit\Form;

use M2E\OnBuy\Block\Adminhtml\Magento\Form\AbstractForm;
use M2E\OnBuy\Model\Policy\Description as DescriptionAlias;
...
class Data extends AbstractForm
{
    ...
    private $attributes = [];
    /** @var \M2E\OnBuy\Model\Policy\Description\BuilderFactory */
    private DescriptionAlias\BuilderFactory $templateDescriptionBuilderFactory;

    public function __construct(
        \M2E\OnBuy\Model\Policy\Description\BuilderFactory $templateDescriptionBuilderFactory,
    ...
    protected function _prepareForm()
    {
            ...
            [
                ...
                'tooltip' => __(
                    'Adds small thumbnails that appear under the large Base Image.
                     You can add up to 8 additional photos to each Listing on OnBuy.
        ...
        $fieldset->addField(
            ...
            [
                ...
                'tooltip' => __(
                    'This is the Title that Buyers will see on OnBuy. A good Title ensures better visibility.'
                ),
            ]
        );
        ...
        $button = $this->getLayout()->createBlock(
            \M2E\OnBuy\Block\Adminhtml\Magento\Button\MagentoAttribute::class
        )
                       ->addData(
                           [
                               'label' => __('Insert'),
        ...
        $selectAttrBlock = $this->elementFactory->create(
            ...
            [
                'data' => [
                    ...
                    'class' => 'OnBuy-required-when-visible magento-attribute-custom-input',
                    'create_magento_attribute' => true,
                ],
            ]
        ...
        $button = $this->getLayout()->createBlock(\M2E\OnBuy\Block\Adminhtml\Magento\Button::class)->addData(
            [
                'label' => __('Preview'),
                'onclick' => 'OnBuyTemplateDescriptionObj.openPreviewPopup()',
        ...
        $fieldset->addField(
            ...
            [
                ...
                'class' => 'OnBuy-validate-description-mode',
                'required' => true,
        ...
        if ($isCustomDescription) {
            $fieldset->addField(
                ...
                [
                    ...
                    'onclick' => 'OnBuyTemplateDescriptionObj.view_edit_custom_change()',
                    'href' => 'javascript://',
        ...
        $fieldset->addField(
            ...
            [
                ...
                'class' => ' admin__control-textarea left OnBuy-validate-description-template',
...
HTML
        ...
        $this->jsPhp->addConstants(
            [
                '\M2E\OnBuy\Model\Policy\Description::DESCRIPTION_MODE_CUSTOM' => \M2E\OnBuy\Model\Policy\Description::DESCRIPTION_MODE_CUSTOM,
            ]
        );
        ...
        $this->js->add(
            <<<JS
    require([
        'OnBuy/Template/Description',
        'OnBuy/Plugin/Magento/Attribute/Button'
    ], function(){
        window.OnBuyTemplateDescriptionObj = new OnBuyTemplateDescription();
        setTimeout(function() {
            OnBuyTemplateDescriptionObj.initObservers();
        }, 50);
...
JS
    ...
    {
        $template = $this->globalDataHelper->getValue('onbuy_template_description');
    ...
    protected function getCustomInsertsHtml()
    {
        ...
        $button = $this->getLayout()->createBlock(\M2E\OnBuy\Block\Adminhtml\Magento\Button::class)->setData(
            [
                'label' => __('Insert'),
                'class' => 'action-primary',
                'onclick' => 'OnBuyTemplateDescriptionObj.insertProductAttribute()',
        ...
        $fieldset->addField(
            ...
            [
                ...
                'class' => 'OnBuy-custom-attribute-can-be-created',
                'values' => $preparedAttributes,
        ...
        $button->setData('onclick', 'OnBuyTemplateDescriptionObj.insertOnBuyAttribute()');

        $fieldset->addField(
            'custom_inserts_OnBuy_attribute',
            'select',
            [
                'label' => __('M2E OnBuy'),
                'values' => $OnBuyAttributes,
                'after_element_html' => $button->toHtml(),
            ]
        );
    ...
    private function getDescriptionPreviewHtml()
    {
        ...
        $button = $this->getLayout()->createBlock(\M2E\OnBuy\Block\Adminhtml\Magento\Button::class)->addData(
            [
                ...
                'onclick' => 'OnBuyTemplateDescriptionObj.selectProductIdRandomly()',
                'class' => 'action-primary',
        ...
        $fieldset->addField(
            ...
            [
                ...
                'after_element_html' => $button->toHtml(),
                'class' => 'OnBuy-required-when-visible validate-digits
                                         OnBuy-validate-magento-product-id',
                'css_class' => '_required',
                'style' => 'width: 200px',
