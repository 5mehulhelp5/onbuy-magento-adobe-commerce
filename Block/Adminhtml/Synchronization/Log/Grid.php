...
namespace M2E\OnBuy\Block\Adminhtml\Synchronization\Log;

class Grid extends \M2E\OnBuy\Block\Adminhtml\Log\AbstractGrid
{
    private array $actionsTitles = [];
    private \M2E\OnBuy\Model\ResourceModel\Synchronization\Log\CollectionFactory $syncLogCollectionFactory;

    public function __construct(
        \M2E\OnBuy\Model\ResourceModel\Synchronization\Log\CollectionFactory $syncLogCollectionFactory,
    ...
    public function _construct()
    {
        ...
        $this->setId('synchronizationLogGrid' . $task . 'OnBuy');
        ...
        $this->actionsTitles = \M2E\OnBuy\Helper\Module\Log::getActionsTitlesByClass(
    ...
    {
        return [
            \M2E\OnBuy\Model\Log\AbstractModel::TYPE_WARNING => (string)__('Warning'),
            \M2E\OnBuy\Model\Log\AbstractModel::TYPE_ERROR => (string)__('Error'),
            \M2E\OnBuy\Model\Synchronization\Log::TYPE_FATAL_ERROR => (string)__('Fatal Error'),
        ];
    }
    ...
    /**
     * @param \M2E\OnBuy\Model\ResourceModel\Synchronization\Log\Collection $collection
     * @param \M2E\OnBuy\Block\Adminhtml\Widget\Grid\Column\Extended\Rewrite $column
     *
     * @return void
     */
    protected function callbackFilterTask($collection, $column): void
    {
        ...
        if ((int)$taskCode === \M2E\OnBuy\Model\Synchronization\Log::TASK_ALL) {
            return;
        }

        $collection->addFieldToFilter(
            \M2E\OnBuy\Model\ResourceModel\Synchronization\Log::COLUMN_TASK,
            ['eq' => (int)$taskCode]
        );
    }
