...
namespace M2E\OnBuy\Block\Adminhtml\Order\Item\Product\Options;
...
class Mapping extends AbstractContainer
{
    ...
    public function getOrderItem(): \M2E\OnBuy\Model\Order\Item
    {
    ...
    protected function _beforeToHtml()
    {
        ...
        if ($this->magentoProduct->isGroupedType()) {
            $magentoOptionLabel = __(
                \M2E\OnBuy\Model\Magento\Product\Variation::GROUPED_PRODUCT_ATTRIBUTE_LABEL
            );
        ...
        $this->setChild(
            ...
            $this->getLayout()->createBlock(\M2E\OnBuy\Block\Adminhtml\HelpBlock::class)->setData([
                'content' => __('As M2E OnBuy Connect was not able to find appropriate Option in Magento Product ' .
