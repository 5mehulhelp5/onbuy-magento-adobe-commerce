...
namespace M2E\OnBuy\Block\Adminhtml\Order\Item\Product;
...
class Mapping extends AbstractContainer
{
    ...
    protected function _beforeToHtml()
    {
        $mappingGrid = $this
            ->getLayout()
            ->createBlock(\M2E\OnBuy\Block\Adminhtml\Order\Item\Product\Mapping\Grid::class);

        $this->setChild('product_mapping_grid', $mappingGrid);

        $helpBlockHtml = __('As M2E OnBuy Connect was not able to find appropriate Product ' .
