...
namespace M2E\OnBuy\Block\Adminhtml\Tag;
...
class Switcher extends \M2E\OnBuy\Block\Adminhtml\Switcher
{
    ...
    private \M2E\OnBuy\Model\Tag\ListingProduct\Repository $tagRelationRepository;
    private string $label;

    public function __construct(
        string $label,
        string $controllerName,
        \M2E\OnBuy\Model\Tag\ListingProduct\Repository $tagRelationRepository,
