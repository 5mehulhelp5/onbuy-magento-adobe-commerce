...
class Form extends AbstractForm
{
    ...
    protected function _prepareForm()
    {
        ...
        $classes = 'validate-length maximum-length-30 OnBuy-validate-attribute-code ';
        $classes .= 'OnBuy-validate-attribute-code-to-be-unique';
    ...
    protected function _toHtml()
    {
        ...
        jQuery.validator.addMethod('OnBuy-validate-attribute-code', function(value, element) {
            return handler.validateAttributeCode(value, element);
        }, OnBuy.translator.translate('Invalid attribute code'));

        jQuery.validator.addMethod('OnBuy-validate-attribute-code-to-be-unique', function(value, element) {
            return handler.validateAttributeCodeToBeUnique(value, element);
        }, OnBuy.translator.translate('Attribute with the same code already exists'));
JS
        );
