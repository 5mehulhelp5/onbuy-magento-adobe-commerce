...
for an item that does <b>not</b> belong to the %extension_title Listing.',
        ...
        $none = [
            'value' => \M2E\OnBuy\Model\Magento\Product::TAX_CLASS_ID_NONE,
            'label' => __('None'),
        ];
        ...
        $fieldset = $form->addFieldset(
            'magento_block_onbuy_accounts_magento_orders_number',
            [
        ...
        $shipByDateFieldset = $form->addFieldset(
            'magento_block_onbuy_accounts_magento_orders_shipping_information',
            [
        ...
        $fieldset = $form->addFieldset(
            'magento_block_onbuy_accounts_magento_orders_customer',
            [
        ...
        $fieldset->addField(
            ...
            [
                ...
                'class' => 'validate-digits OnBuy-account-customer-id',
        ...
        $fieldset = $form->addFieldset(
            'magento_block_onbuy_accounts_magento_orders_tax',
            [
        ...
        $fieldset = $form->addFieldset(
            'magento_block_onbuy_accounts_magento_orders_status_mapping',
            [
        ...
        $fieldset->addField(
            ...
            [
                ...
                'values' => [
                    \M2E\OnBuy\Model\Account\Settings\Order::ORDERS_STATUS_MAPPING_MODE_DEFAULT => __('Default Order Statuses'),
                    \M2E\OnBuy\Model\Account\Settings\Order::ORDERS_STATUS_MAPPING_MODE_CUSTOM => __('Custom Order Statuses'),
                ],
