...
namespace M2E\OnBuy\Block\Adminhtml\Wizard\Installation\Registration;
...
abstract class Content extends AbstractForm
{
    ...
    protected function _prepareLayout()
    {
        $this->getLayout()->getBlock('wizard.help.block')->setContent(
            (string)__(
                'M2E OnBuy Connect requires activation for further work. To activate your installation,
