define([
    ...
    window.OrderNote = Class.create(Grid, {
        ...
        openAddNotePopup: function (orderId) {
            new Ajax.Request(OnBuy.url.get('order/getNotePopupHtml'), {
                method: 'post',
                parameters: {
                    order_id: orderId
                },
        ...
        openPopup: function (content) {
            ...
            var popup = jQuery(modalDialogMessage).modal({
                title: OnBuy.translator.translate('Custom Note'),
        ...
        saveNote: function () {
            ...
            new Ajax.Request(OnBuy.url.get('order/saveNote'), {
                method: 'post',
        ...
        deleteNote: function (noteId) {
            if (!confirm(OnBuy.translator.translate('Are you sure?'))) {
                return;
            }

            new Ajax.Request(OnBuy.url.get('order/deleteNote'), {
                method: 'post',
                parameters: {
                    note_id: noteId
                },
