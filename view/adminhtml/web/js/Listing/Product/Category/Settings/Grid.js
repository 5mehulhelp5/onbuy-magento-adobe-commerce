define([
    ...
    window.OnBuyListingProductCategorySettingsGrid = Class.create(Grid, {
            ...
            new Ajax.Request(OnBuy.url.get('listing_product_category_settings/stepTwoModeValidate'), {
                ...
                onSuccess: function (transport) {
                    ...
                    if (response['validation']) {
                        return setLocation(OnBuy.url.get('listing_product_category_settings/step_assign_category'));
                    }
