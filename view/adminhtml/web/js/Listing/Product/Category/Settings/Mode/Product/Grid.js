define([
    ...
    'OnBuy/Plugin/Messages',
    'OnBuy/Grid'
], function (jQuery, modal, MessageObj) {

    window.OnBuyListingProductCategorySettingsModeProductGrid = Class.create(Grid, {
        ...
        editCategories: function () {
            ...
            new Ajax.Request(OnBuy.url.get('listing_product_category_settings/getChooserBlockHtml'), {
                method: 'post',
                asynchronous: true,
                parameters: {
                ...
                onSuccess: function (transport) {
                    this.openPopUp(
                            OnBuy.translator.translate('Category Settings'),
        ...
        resetCategories: function (id) {
            ...
            new Ajax.Request(OnBuy.url.get('listing_product_category_settings/stepTwoReset'), {
                method: 'post',
                asynchronous: true,
                parameters: {
        ...
        validateCategories: function (isAlLeasOneCategorySelected, showErrorMessage) {
            ...
            if (parseInt(isAlLeasOneCategorySelected)) {
                ...
                if (parseInt(showErrorMessage)) {
                    MessageObj.addWarning(OnBuy.translator.translate('select_relevant_category'));
                }
            } else {
        ...
        confirmCategoriesData: function () {
            ...
            let selectedCategory = OnBuyCategoryChooserObj.selectedCategory;

            this.saveCategoriesData(selectedCategory);
        },

        saveCategoriesData: function (templateData) {
            new Ajax.Request(OnBuy.url.get('listing_product_category_settings/stepTwoSaveToSession'), {
                method: 'post',
                parameters: {
        ...
        completeCategoriesDataStep: function (validateCategory, validateSpecifics) {
            ...
            new Ajax.Request(OnBuy.url.get('listing_product_category_settings/stepTwoModeValidate'), {
                method: 'post',
                asynchronous: true,
                parameters: {
                ...
                onSuccess: function (transport) {
                    ...
                    modal({
                        title: OnBuy.translator.translate('Set OnBuy Shop Category'),
                        type: 'popup',
                        buttons: [{
                            text: OnBuy.translator.translate('Cancel'),
                            ...
                            text: OnBuy.translator.translate('Continue'),
                            class: 'action-primary action-accept forward',
                            id: 'save_popup_button',
                            click: function () {
                                this.closeModal();
                                setLocation(OnBuy.url.get('listing_product_category_settings/step_3'));
                            }
                        }]
                    }, popup);
