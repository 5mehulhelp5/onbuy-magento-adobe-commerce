    ...
    window.ListingEditListingTitle = Class.create({
        ...
        initialize: function (gridId) {
            ...
            CommonObj.setValidationCheckRepetitionValue(
                    'OnBuy-listing-title',
                    OnBuy.translator.translate('The specified Title is already used for other Listing. Listing Title must be unique.'),
        ...
        openPopup: function (id) {
            ...
            new Ajax.Request(OnBuy.url.get('listing_edit/title'), {
                method: 'GET',
                parameters: {
                    id: id
                },
                onSuccess: (function (transport) {
                    ...
                    modal({
                        title: OnBuy.translator.translate('Edit Listing Title'),
                        type: 'popup',
                        modalClass: 'width-50',
                        buttons: [{
        ...
        saveListingTitle: function () {
            ...
            confirm({
                content: OnBuy.translator.translate('Are you sure?'),
                actions: {
                    confirm: function () {
                        new Ajax.Request(OnBuy.url.get('listing_edit/title'), {
