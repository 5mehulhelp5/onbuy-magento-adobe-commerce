define([
    ...
    window.OnBuyListingSettings = Class.create(Common, {
        ...
        initObservers: function () {
            ...
            $('template_selling_format_id').observe('change', function () {
                OnBuyListingSettingsObj.checkSellingFormatMessages();
        ...
        saveClick: function (url) {
            ...
            if (typeof url == 'undefined' || url == '') {
                url = OnBuy.url.formSubmit + 'back/' + base64_encode('list') + '/';
            }
        ...
        checkSellingFormatMessages: function () {
            ...
            var siteId = $('site_id').value;

            if (storeId.empty() || storeId < 0 || siteId.empty() || siteId < 0) {
                return;
            }
            ...
            new Ajax.Request(url, {
                ...
                onSuccess: function (transport) {
                    ...
                    if (currentValue != '') {
                        ...
                        if (OnBuy.formData[id] > 0) {
                            $(id).value = OnBuy.formData[id];
                        } else {
        ...
        newSellingFormatTemplateCallback: function () {
            ...
            OnBuyListingSettingsObj.reload(OnBuy.url.get('getSellingFormatTemplates'), 'template_selling_format_id');
        ...
        newSynchronizationTemplateCallback: function () {
            ...
            OnBuyListingSettingsObj.reload(OnBuy.url.get('getSynchronizationTemplates'), 'template_synchronization_id');
