define([
    ...
    window.ListingMoving = Class.create(Action, {
        ...
        openPopUp: function (gridHtml, popup_title, buttons) {
            ...
            if (typeof buttons === 'undefined') {
                buttons = [{
                    ...
                    text: OnBuy.translator.translate('Add New Listing'),
                    class: 'action-primary action-accept',
                    click: function () {
                        self.startListingCreation(OnBuy.url.get('add_new_listing_url'));
                    }
                }];
            }
        ...
        prepareData: function (parts, partsCount, isFirstPart) {
            ...
            new Ajax.Request(OnBuy.url.get('prepareData'), {
                method: 'post',
                parameters: {
        ...
        moveToListingGrid: function () {
            ...
            new Ajax.Request(OnBuy.url.get('moveToListingGridHtml'), {
                method: 'get',
                parameters: {
                    accountId: self.accountId,
                    shopId: self.shopId,
                    ignoreListings: OnBuy.customData.ignoreListings
                },
                onSuccess: (function (transport) {
                    self.completeProgressBar();
                    self.openPopUp(transport.responseText, OnBuy.translator.translate('popup_title'));
                })
            });
        },
        ...
        submit: function (listingId, onSuccess) {
            ...
            new Ajax.Request(OnBuy.url.get('createListing'), {
                method: 'post',
                parameters: {
                    listingId: listingId
                },
