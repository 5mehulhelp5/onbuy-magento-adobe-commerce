define([
    ...
    window.ListingWizardCategoryModeManuallyGrid = Class.create(Grid, {
        ...
        editCategories: function () {
            ...
            new Ajax.Request(OnBuy.url.get('listing_wizard_category/chooserBlockModeManually'), {
                method: 'post',
                asynchronous: true,
                parameters: {
        ...
        resetCategories: function (id) {
            ...
            new Ajax.Request(OnBuy.url.get('listing_wizard_category/resetModeManually'), {
                method: 'post',
                asynchronous: true,
                parameters: {
        ...
        confirmCategoriesData: function () {
            ...
            const selectedCategory = OnBuyCategoryChooserObj.selectedCategory;

            OnBuyCategoryChooserObj.messagesClearAll()
            if (!selectedCategory.is_all_required_attributes_filled) {
                OnBuyCategoryChooserObj.messageAddErrorToModalHeaderBlock($t('Please complete all required attributes to proceed.'));
                return;
            }
        ...
        saveCategoriesData: function (templateData) {
            ...
            new Ajax.Request(OnBuy.url.get('listing_wizard_category/saveModeManually'), {
                method: 'post',
                parameters: {
        ...
        completeCategoriesDataStep: function (validateCategory, validateSpecifics) {
            ...
            new Ajax.Request(OnBuy.url.get('listing_wizard_category/validateModeManually'), {
                method: 'post',
                asynchronous: true,
                parameters: {
                ...
                onSuccess: function (transport) {
                    ...
                    if (response.validation) {
                        return setLocation(
                            OnBuy.url.get('listing_wizard_category/complete_step', {'id': wizard_id})
                        );
                    }
