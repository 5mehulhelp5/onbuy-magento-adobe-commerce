define([
    ...
    window.OnBuyListingCategory = Class.create(Common, {
        ...
        getChooserSelectedCategory: function () {
            return OnBuyCategoryChooserObj.selectedCategory;
        },

        getChooserSelectedAttributes: function () {
            return OnBuyCategoryChooserObj.selectedSpecifics;
        },
        ...
        editCategorySettings: function (id) {
            ...
            const url = OnBuy.url.get('listing_product_category_settings/edit');
        ...
        saveCategorySettings: function (selectedCategory) {
            ...
            new Ajax.Request(OnBuy.url.get('listing/saveCategoryTemplate'), {
                method: 'post',
                asynchronous: true,
                parameters: {
                ...
                onSuccess: function (transport) {
                    window.OnBuyCategoryAttributeValidationPopup.closePopupCallback = function () {
                        self.cancelCategorySettings()
                    }
                    window.OnBuyCategoryAttributeValidationPopup.open(selectedCategory.dictionaryId);
                }.bind(this)
            });
        },
