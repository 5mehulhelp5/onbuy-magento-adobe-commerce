define([
    ...
    'OnBuy/Action',
    'OnBuy/Plugin/ProgressBar',
    'OnBuy/Plugin/AreaWrapper'
], function (MessageObj) {
    ...
    window.ListingViewAction = Class.create(Action, {
        ...
        sendPartsOfProducts: function (parts, totalPartsCount, url, requestParams) {
            ...
            if (parts.length == 0) {
                ...
                self.progressBarObj.setStatus(OnBuy.translator.translate('task_completed_message'));
                ...
                if (combineResult == 'error') {
                    ...
                    if (self.errorMessages.length > 0) {
                        ...
                        let message = OnBuy.translator.translate('task_completed_error_message');
                        message = message.replace('%task_title%', self.progressBarObj.getTitle());
                        message = message.replace('%url%', OnBuy.url.get('logViewUrl'));
                    ...
                    new Ajax.Request(OnBuy.url.get('getErrorsSummary') + 'action_ids/' + actionIds + '/', {
                        method: 'get',
                    ...
                    let message = OnBuy.translator.translate('task_completed_warning_message');
                    message = message.replace('%task_title%', self.progressBarObj.getTitle());
                    message = message.replace('%url%', OnBuy.url.get('logViewUrl'));

                    self.messageObj.addWarning(message);
                } else {
                    let message = OnBuy.translator.translate('task_completed_success_message');
                    message = message.replace('%task_title%', self.progressBarObj.getTitle());
            ...
            self.progressBarObj.setStatus(
                    str_replace(
                            '%product_title%',
                            partExecuteString,
                            OnBuy.translator.translate('sending_data_message')
                    )
            );
        ...
        listAction: function () {
            ...
            this.startActions(
                    OnBuy.translator.translate('listing_selected_items_message'),
                    OnBuy.url.get('runListProducts'),
        ...
        relistAction: function () {
            ...
            this.startActions(
                    OnBuy.translator.translate('relisting_selected_items_message'),
                    OnBuy.url.get('runRelistProducts'),
                    selectedProductsParts
            );
        },
        ...
        reviseAction: function () {
            ...
            this.startActions(
                    OnBuy.translator.translate('revising_selected_items_message'),
                    OnBuy.url.get('runReviseProducts'),
                    selectedProductsParts
            );
        },
        ...
        stopAction: function () {
            ...
            this.startActions(
                    OnBuy.translator.translate('stopping_selected_items_message'),
                    OnBuy.url.get('runStopProducts'),
                    selectedProductsParts,
                    requestParams
            );
        },
        ...
        stopAndRemoveAction: function () {
            ...
            this.startActions(
                    OnBuy.translator.translate('stopping_and_removing_selected_items_message'),
                    OnBuy.url.get('runStopAndRemoveProducts'),
                    selectedProductsParts,
                    requestParams
            );
        },
        ...
        previewItemsAction: function () {
            ...
            this.openWindow(
                    OnBuy.url.get('previewItems') + 'productIds/' + implode(',', orderedSelectedProductsArray)
