define([
    ...
    window.TemplateHelperPriceChange = Class.create(Common, {
        ...
        constAbsoluteIncrease: OnBuy.php.constant(
                '\\M2E\\OnBuy\\Model\\Policy\\SellingFormat::PRICE_MODIFIER_ABSOLUTE_INCREASE'
        ),
        constAbsoluteDecrease: OnBuy.php.constant(
                '\\M2E\\OnBuy\\Model\\Policy\\SellingFormat::PRICE_MODIFIER_ABSOLUTE_DECREASE'
        ),
        constPercentageIncrease: OnBuy.php.constant(
                '\\M2E\\OnBuy\\Model\\Policy\\SellingFormat::PRICE_MODIFIER_PERCENTAGE_INCREASE'
        ),
        constPercentageDecrease: OnBuy.php.constant(
                '\\M2E\\OnBuy\\Model\\Policy\\SellingFormat::PRICE_MODIFIER_PERCENTAGE_DECREASE'
        ),
        constAttribute: OnBuy.php.constant(
                '\\M2E\\OnBuy\\Model\\Policy\\SellingFormat::PRICE_MODIFIER_ATTRIBUTE'
        ),
