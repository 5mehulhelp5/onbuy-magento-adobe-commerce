define([
    ...
    window.OnBuyTemplateDescription = Class.create(Common, {

        // ---------------------------------------

        initialize: function () {
            jQuery.validator.addMethod('OnBuy-validate-description-mode', function (value, el) {
            ...
            jQuery.validator.addMethod('OnBuy-validate-magento-product-id', function (value) {
            ...
            }, OnBuy.translator.translate('Please enter a valid Magento product ID.'));
        },
        ...
        initObservers: function () {
            ...
            $('title_mode')
                    .observe('change', OnBuyTemplateDescriptionObj.title_mode_change)
                    .simulate('change');

            $('description_mode')
                    .observe('change', OnBuyTemplateDescriptionObj.description_mode_change)
                    .simulate('change');

            $('custom_inserts_open_popup')
                    .observe('click', OnBuyTemplateDescriptionObj.customInsertsOpenPopup);
        ...
        title_mode_change: function () {
            var self = OnBuyTemplateDescriptionObj;
        ...
        initCustomInsertsPopup: function () {
            ...
            popup.modal({
                title: OnBuy.translator.translate('Custom Insertions'),
                type: 'slide',
                buttons: [],
                closed: function () {
                    OnBuyTemplateDescriptionObj.customInsertsOnClosePopup();
                }
            });
        },
        ...
        insertOnBuyAttribute: function () {
            var self = this;

            self.customInsertsClosePopup(function () {
                self.appendToTextarea('#value[' + $('custom_inserts_onbuy_attribute').value + ']#');
            });
        },
        ...
        initPreviewPopup: function () {
            ...
            popup.modal({
                title: OnBuy.translator.translate('Description Preview'),
                type: 'popup',
                buttons: [{
