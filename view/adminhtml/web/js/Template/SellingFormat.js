define([
    ...
    window.OnBuyTemplateSellingFormat = Class.create(Common, {


        priceChangeIndex: 0,
        priceChangeTpl: '',

        constAbsoluteIncrease: OnBuy.php.constant(
                '\\M2E\\OnBuy\\Model\\Policy\\SellingFormat::PRICE_COEFFICIENT_ABSOLUTE_INCREASE'
        ),
        constAbsoluteDecrease: OnBuy.php.constant(
                '\\M2E\\OnBuy\\Model\\Policy\\SellingFormat::PRICE_COEFFICIENT_ABSOLUTE_DECREASE'
        ),
        constPercentageIncrease: OnBuy.php.constant(
                '\\M2E\\OnBuy\\Model\\Policy\\SellingFormat::PRICE_COEFFICIENT_PERCENTAGE_INCREASE'
        ),
        constPercentageDecrease: OnBuy.php.constant(
                '\\M2E\\OnBuy\\Model\\Policy\\SellingFormat::PRICE_COEFFICIENT_PERCENTAGE_DECREASE'
        ),
        constAttribute: OnBuy.php.constant(
                '\\M2E\\OnBuy\\Model\\Policy\\SellingFormat::PRICE_COEFFICIENT_ATTRIBUTE'
        ),
        ...
        initialize: function () {
            var self = this;
            jQuery.validator.addMethod('OnBuy-validate-price-coefficient', function (value, el) {
                ...
                var floatValidator = Validation.get('OnBuy-validation-float');
                ...
                return true;
            }, OnBuy.translator.translate('Price Change is not valid.'));

            jQuery.validator.addMethod('OnBuy-validate-price-modifier', function (value, el) {
                if (self.isElementHiddenFromPage(el)) {
                    return true;
                }
            ...
            jQuery.validator.addMethod('OnBuy-validate-qty', function (value, el) {
                ...
                return true;
            }, OnBuy.translator.translate('Wrong value. Only integer numbers.'));
        ...
        updateQtyPercentage: function () {
            ...
            if (qtyMode == OnBuy.php.constant('\\M2E\\OnBuy\\Model\\Policy\\SellingFormat::QTY_MODE_NUMBER')) {
                return;
            }
        ...
        qty_mode_change: function () {
            var self = OnBuyTemplateSellingFormatObj,
            ...
            if (this.value == OnBuy.php.constant('\\M2E\\OnBuy\\Model\\Policy\\SellingFormat::QTY_MODE_NUMBER')) {
                customValueTr.show();
            } else if (this.value == OnBuy.php.constant('\\M2E\\OnBuy\\Model\\Policy\\SellingFormat::QTY_MODE_ATTRIBUTE')) {
                self.selectMagentoAttribute(this, attributeElement);
            }

            maxPostedValueTr.hide();
            maxPostedValueMode.value = OnBuy.php.constant('\\M2E\\OnBuy\\Model\\Policy\\SellingFormat::QTY_MODIFICATION_MODE_OFF');

            if (self.isMaxPostedQtyAvailable(this.value)) {

                maxPostedValueTr.show();
                maxPostedValueMode.value = OnBuy.php.constant('\\M2E\\OnBuy\\Model\\Policy\\SellingFormat::QTY_MODIFICATION_MODE_ON');

                if (self.isMaxPostedQtyAvailable(OnBuy.formData.qty_mode)) {
                    maxPostedValueMode.value = OnBuy.formData.qty_modification_mode;
                }
            }
        ...
        isMaxPostedQtyAvailable: function (qtyMode) {
            return qtyMode == OnBuy.php.constant('\\M2E\\OnBuy\\Model\\Policy\\SellingFormat::QTY_MODE_PRODUCT') ||
                    qtyMode == OnBuy.php.constant('\\M2E\\OnBuy\\Model\\Policy\\SellingFormat::QTY_MODE_ATTRIBUTE') ||
                    qtyMode == OnBuy.php.constant('\\M2E\\OnBuy\\Model\\Policy\\SellingFormat::QTY_MODE_PRODUCT_FIXED');
        },
        ...
        qtyPostedMode_change: function () {
            ...
            if (this.value == OnBuy.php.constant('\\M2E\\OnBuy\\Model\\Policy\\SellingFormat::QTY_MODIFICATION_MODE_ON')) {
        ...
        fixed_price_mode_change: function (self) {
            ...
            attributeElement.value = '';
            if (this.value == OnBuy.php.constant('\\M2E\\OnBuy\\Model\\Policy\\SellingFormat::PRICE_MODE_ATTRIBUTE')) {
                OnBuyTemplateSellingFormatObj.selectMagentoAttribute(this, attributeElement);
            }
        },
        ...
        price_coefficient_mode_change: function () {
            ...
            if (this.value == OnBuy.php.constant('\\M2E\\OnBuy\\Model\\Policy\\SellingFormat::PRICE_COEFFICIENT_NONE')) {
            ...
            if (this.value == OnBuy.php.constant('\\M2E\\OnBuy\\Model\\Policy\\SellingFormat::PRICE_COEFFICIENT_ABSOLUTE_INCREASE')) {
                signSpan.innerHTML = '+';

                if (typeof OnBuy.formData.currency != 'undefined') {
                    percentSpan.innerHTML = OnBuy.formData.currency;
                }

                $(this.id.replace('coefficient_mode', '') + 'example_absolute_increase').show();
            }

            if (this.value == OnBuy.php.constant('\\M2E\\OnBuy\\Model\\Policy\\SellingFormat::PRICE_COEFFICIENT_ABSOLUTE_DECREASE')) {
                signSpan.innerHTML = '-';
            ...
            if (this.value == OnBuy.php.constant('\\M2E\\OnBuy\\Model\\Policy\\SellingFormat::PRICE_COEFFICIENT_PERCENTAGE_INCREASE')) {
                signSpan.innerHTML = '+';
                percentSpan.innerHTML = '%';
            ...
            if (this.value == OnBuy.php.constant('\\M2E\\OnBuy\\Model\\Policy\\SellingFormat::PRICE_COEFFICIENT_PERCENTAGE_DECREASE')) {
                signSpan.innerHTML = '-';
                percentSpan.innerHTML = '%';
        ...
        checkMessages: function (data, container) {
            if (typeof OnBuyListingTemplateSwitcherObj == 'undefined') {
                // not inside template switcher
                return;
            }

            var id = '',
                    nick = OnBuy.php.constant('M2E_OnBuy_Model_OnBuy_Template_Manager::TEMPLATE_SELLING_FORMAT'),
                    storeId = OnBuyListingTemplateSwitcherObj.storeId,
                    callback = function () {
