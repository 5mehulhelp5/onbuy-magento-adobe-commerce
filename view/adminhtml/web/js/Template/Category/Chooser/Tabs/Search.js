define([
    ...
    window.OnBuyTemplateCategoryChooserTabsSearch = Class.create(Common, {
        ...
        /**
         * @param {OnBuyCategoryChooser} categoryChooser
        ...
        search: function (searchQuery) {
            ...
            new Ajax.Request(OnBuy.url.get('category/search'), {
                method: 'post',
                asynchronous: true,
                parameters: {
                    "search_query": searchQuery,
                    "site_id": self.categoryChooser.getSiteId()
                },
