define([
    ...
    window.OnBuyTemplateCategoryChooserTabsBrowse = Class.create(Common, {
        ...
        getSelectedCategories: function () {
            var self = OnBuyTemplateCategoryChooserTabsBrowseObj;
        ...
        renderChildCategories: function (parentCategoryId) {
            ...
            new Ajax.Request(OnBuy.url.get('category/getChildCategories'), {
                method: 'post',
                asynchronous: true,
                parameters: {
        ...
        prepareDomStructure: function (categoryId, parentDiv) {
            ...
            childrenSelect.onchange = function () {
                OnBuyTemplateCategoryChooserTabsBrowseObj.onSelectCategory(this);
            };
