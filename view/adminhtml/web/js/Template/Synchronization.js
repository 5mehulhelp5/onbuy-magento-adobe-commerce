define([
    ...
    window.OnBuyTemplateSynchronization = Class.create(Common, {
        // ---------------------------------------
        ...
        initialize: function () {
            ...
            jQuery.validator.addMethod('OnBuy-validate-stop-relist-conditions-product-status', function (value, el) {

                if (OnBuyTemplateSynchronizationObj.isRelistModeDisabled()) {
                    return true;
                }

                if (OnBuyTemplateSynchronizationObj.isStopModeDisabled()) {
                    return true;
                }
                ...
                return true;
            }, OnBuy.translator.translate('Inconsistent Settings in Relist and Stop Rules.'));

            jQuery.validator.addMethod('OnBuy-validate-stop-relist-conditions-stock-availability', function (value, el) {
            ...
            jQuery.validator.addMethod('OnBuy-validate-stop-relist-conditions-item-qty', function (value, el) {
                ...
                switch (parseInt($('stop_qty_calculated').value)) {
                    ...
                    case OnBuy.php.constant('M2E_OnBuy_Model_Policy_Synchronization::QTY_MODE_NONE'):
                        return true;
                        break;

                    case OnBuy.php.constant('M2E_OnBuy_Model_Policy_Synchronization::QTY_MODE_YES'):
        ...
        initObservers: function () {
            ...
            //list
            $('list_mode')
                    .observe('change', OnBuyTemplateSynchronizationObj.listMode_change).simulate('change');

            $('list_qty_calculated')
                    .observe('change', OnBuyTemplateSynchronizationObj.listQtyChange)
                    .simulate('change');

            $('list_advanced_rules_mode')
                    .observe('change', OnBuyTemplateSynchronizationObj.listAdvancedRules_change)
                    .simulate('change');

            //relist
            $('relist_mode')
                    .observe('change', OnBuyTemplateSynchronizationObj.relistMode_change)
                    .simulate('change');

            $('relist_qty_calculated')
                    .observe('change', OnBuyTemplateSynchronizationObj.relistQtyChange)
                    .simulate('change');

            $('relist_advanced_rules_mode')
                    .observe('change', OnBuyTemplateSynchronizationObj.relistAdvancedRules_change)
                    .simulate('change');

            //revise
            $('revise_update_qty')
                    .observe('change', OnBuyTemplateSynchronizationObj.reviseQty_change)
                    .simulate('change');

            $('revise_update_qty_max_applied_value_mode')
                    .observe('change', OnBuyTemplateSynchronizationObj.reviseQtyMaxAppliedValueMode_change)
                    .simulate('change');

            //stop
            $('stop_mode').observe('change', OnBuyTemplateSynchronizationObj.stopMode_change)
                    .simulate('change');

            $('stop_qty_calculated')
                    .observe('change', OnBuyTemplateSynchronizationObj.stopQtyChange)
                    .simulate('change');

            $('stop_advanced_rules_mode')
                    .observe('change', OnBuyTemplateSynchronizationObj.stopAdvancedRules_change)
                    .simulate('change');
        },
        ...
        listQtyChange: function () {
            ...
            if (this.value == OnBuy.php.constant('M2E_OnBuy_Model_Policy_Synchronization::QTY_MODE_YES')) {
                valueContainer.show();
            }
        },
        ...
        reviseQtyMaxAppliedValueMode_change: function (event) {
            var self = OnBuyTemplateSynchronizationObj;
        ...
        openReviseMaxAppliedQtyDisableConfirmationPopUp: function () {
            ...
            element.confirm({
                title: OnBuy.translator.translate('Are you sure?'),
                actions: {
        ...
        relistQtyChange: function (event) {
            OnBuyTemplateSynchronizationObj.qtyChange(event, this, 'relist');
        },

        // ---------------------------------------

        stopQtyChange: function (event) {
            OnBuyTemplateSynchronizationObj.qtyChange(event, this, 'stop');
        },
        ...
        qtyChange: function (event, element, action) {
            ...
            if (element.value == OnBuy.php.constant('M2E_OnBuy_Model_Policy_Synchronization::QTY_MODE_YES')) {
                qtyCalculatedValue.show();
            } else if (!event.cancelable) {
                OnBuyTemplateSynchronizationObj.openQtyCalculatedConfirmationPopUp(element, action);
            }
        },
