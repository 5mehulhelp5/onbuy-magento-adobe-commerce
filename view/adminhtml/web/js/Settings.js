            ...
            uiTabs.forEach(item => {
                ...
                if (isFormValid) {
                    ...
                    if (form.length) {
                        ...
                        this.submitTab(OnBuy.url.get(elementId), formData);
                    }
                }
            })
        },
            ...
            jQuery(modalDialogMessage).confirm({
                ...
                actions: {
                    confirm: function () {
                        ...
                        new Ajax.Request(OnBuy.url.get('settings_interface/restoreRememberedChoices'), {
                            method: 'get',
                            asynchronous: true,
                            onSuccess: function (transport) {
                                ...
                                self.messageObj.addSuccess(
                                        OnBuy.translator.translate('Help Blocks have been restored.')
                                );
                            }
                        });
                    }
        ...
        submitTab: function (url, formData) {
            ...
            new Ajax.Request(url, {
                ...
                onSuccess: function (transport) {
                    ...
                    if (result.success) {
                        self.messageObj.addSuccess(OnBuy.translator.translate('Settings saved'));
                    } else {
                        self.messageObj.addError(OnBuy.translator.translate('Error'));
                    }
