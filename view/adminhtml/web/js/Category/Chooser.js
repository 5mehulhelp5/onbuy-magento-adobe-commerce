define([
    ...
    'mage/translate',
    'OnBuy/Common',
    'OnBuy/Plugin/Magento/AttributeCreator'
], function (jQuery, modal, MessageObj, $t) {
    window.OnBuyCategoryChooser = Class.create(Common, {
        ...
        initialize: function (siteId, accountId) {
            this.siteId = siteId;
        ...
        showEditCategoryPopUp: function () {
            ...
            new Ajax.Request(OnBuy.url.get('category/getChooserEditHtml'), {
                method: 'post',
                parameters: {
                    site_id: self.siteId,
        ...
        selectCategory: function (categoryId) {
            ...
            new Ajax.Request(OnBuy.url.get('category/getSelectedCategoryDetails'), {
                method: 'post',
                parameters: {
                    site_id: self.siteId,
                    value: categoryId,
        ...
        confirmCategory: function () {
            ...
            if (self.isCategorySelected() && self.selectedCategory.value) {
                new Ajax.Request(OnBuy.url.get('category/getEditedCategoryInfo'), {
                    method: 'post',
                    parameters: {
                        site_id: self.siteId,
        ...
        getCountsOfSpecifics: function (dictionaryId, callback) {
            new Ajax.Request(OnBuy.url.get('category/getCountsOfAttributes'), {
                method: 'post',
                parameters: {
        ...
        renderRecent: function () {
            ...
            new Ajax.Request(OnBuy.url.get('category/getRecent'), {
                method: 'post',
                parameters: {
                    site_id: self.siteId,
                    ...
                    if (transport.responseText.length > 2) {
                        ...
                        categories.each(function (category) {
                            ...
                            html += '<tr><td>' + category.path + '</td>' +
                                    ...
                                    'onclick="OnBuyCategoryChooserObj.selectCategory(\'' + category.id + '\')">' +
                                    $t('Select') + '</a></td></tr>';
        ...
        editAttributes: function () {
            ...
            new Ajax.Request(OnBuy.url.get('category/getCategoryAttributesHtml'), {
                method: 'post',
                asynchronous: true,
                parameters: {
        ...
        confirmSpecifics: function () {
            ...
            const self = OnBuyCategoryChooserObj;

            this.selectedSpecifics = OnBuyTemplateCategorySpecificsObj.collectSpecifics();

            new Ajax.Request(OnBuy.url.get('category/saveCategoryAttributesAjax'), {
                method: 'post',
                parameters: {
