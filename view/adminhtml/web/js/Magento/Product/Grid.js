define([
    ...
    window.MagentoProductGrid = Class.create(Common, {
        ...
        advancedFilterToggle: function () {
            ...
            if (jQuery('#listing_product_rules:visible').length) {
                ...
                if ($$('#advanced_filter_button span span span').length > 0) {
                    $$('#advanced_filter_button span span span')[0].innerHTML = OnBuy.translator.translate('Show Advanced Filter');
                } else {
                    $$('#advanced_filter_button span')[0].innerHTML = OnBuy.translator.translate('Show Advanced Filter');
                }
            } else {
                ...
                if ($$('#advanced_filter_button span span span').length > 0) {
                    $$('#advanced_filter_button span span span')[0].innerHTML = OnBuy.translator.translate('Hide Advanced Filter');
                } else {
                    $$('#advanced_filter_button span')[0].innerHTML = OnBuy.translator.translate('Hide Advanced Filter');
                }
            }
        },
        ...
        getSelectedProducts: function () {
            ...
            if (!selectedProducts) {
                this.alert(OnBuy.translator.translate('Please select the Products you want to perform the Action on.'));
                return false;
            }
