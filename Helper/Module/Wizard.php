...
class Wizard
{
    ...
    private \M2E\OnBuy\Helper\Data\Cache\Permanent $permanentCache;
    ...
    public function __construct(
        ...
        \M2E\OnBuy\Helper\Data\Cache\Permanent $permanentCache
    ) {
    ...
    /**
     * @param \M2E\OnBuy\Model\Wizard $wizard
     *
     * @return string|null
     */
    public function getNick(\M2E\OnBuy\Model\Wizard $wizard): ?string
    {
     ...
     * @param string $view
     *
     * @return null|\M2E\OnBuy\Model\Wizard
     */
    public function getActiveWizard($view)
    {
        $wizards = $this->getAllWizards($view);

        /** @var \M2E\OnBuy\Model\Wizard $wizard */
    ...
    public function getActiveBlockerWizard(string $view): ?\M2E\OnBuy\Model\Wizard
    {
        $wizards = $this->getAllWizards($view);
    ...
    private function loadCache(): void
    {
        ...
        $tableName = $this->moduleDatabaseStructureHelper
            ->getTableNameWithPrefix(\M2E\OnBuy\Helper\Module\Database\Tables::TABLE_NAME_WIZARD);
        ...
        usort($this->cache, function ($a, $b) {
            if ($a['type'] != $b['type']) {
                return $a['type'] == \M2E\OnBuy\Helper\Module\Wizard::TYPE_BLOCKER ? -1 : 1;
            }
    ...
    private function setConfigValue($nick, $key, $value)
    {
        ...
        $tableName = $this->moduleDatabaseStructureHelper->getTableNameWithPrefix('m2e_onbuy_wizard');
