...
abstract class AbstractProduct extends \M2E\OnBuy\Observer\AbstractObserver
{
    ...
    public function beforeProcess(): void
    {
        ...
        if (!($product instanceof \Magento\Catalog\Model\Product)) {
            throw new \M2E\OnBuy\Model\Exception('Product event doesn\'t have correct Product instance.');
        }
    ...
    protected function getProduct()
    {
        if (!($this->product instanceof \Magento\Catalog\Model\Product)) {
            throw new \M2E\OnBuy\Model\Exception\Logic('Property "Product" should be set first.');
        }
