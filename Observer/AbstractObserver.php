...
abstract class AbstractObserver implements \Magento\Framework\Event\ObserverInterface
{
    ...
    public function execute(\Magento\Framework\Event\Observer $observer): void
    {
        ...
        try {
            ...
            $this->getObjectManager()->get(\M2E\OnBuy\Helper\Module\Exception::class)->process($exception);
        }
    }
    ...
    protected function getEventObserver(): \Magento\Framework\Event\Observer
    {
        if (!($this->eventObserver instanceof \Magento\Framework\Event\Observer)) {
            throw new \M2E\OnBuy\Model\Exception\Logic('Property "eventObserver" should be set first.');
        }
    ...
    {
        $moduleHelper = $this->getObjectManager()->get(\M2E\OnBuy\Helper\Module::class);

        return $this->getObjectManager()->get(\M2E\Core\Helper\Magento::class)->isInstalled()
            && !$this->getObjectManager()->get(\M2E\OnBuy\Helper\Module\Maintenance::class)->isEnabled()
