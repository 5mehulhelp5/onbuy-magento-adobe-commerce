...
namespace M2E\OnBuy\Plugin\HealthStatus\Magento\Framework\App;

use Magento\Framework\Message\MessageInterface;
use M2E\OnBuy\Model\HealthStatus\Task\Result;

class FrontController extends \M2E\OnBuy\Plugin\AbstractPlugin
{
    public const MESSAGE_IDENTIFIER = 'onbuy_health_status_front_controller_message';

    /** @var \Magento\Framework\Message\ManagerInterface */
    private $messageManager;
    private \M2E\OnBuy\Model\HealthStatus\CurrentStatus $healthStatusCurrentStatus;
    private \M2E\OnBuy\Model\HealthStatus\Notification\MessageBuilder $notificationMessageBuilder;
    private \M2E\OnBuy\Model\HealthStatus\Notification\Settings $notificationSettings;

    public function __construct(
        \Magento\Framework\Message\ManagerInterface $messageManager,
        \M2E\OnBuy\Model\HealthStatus\CurrentStatus $healthStatusCurrentStatus,
        \M2E\OnBuy\Model\HealthStatus\Notification\MessageBuilder $notificationMessageBuilder,
