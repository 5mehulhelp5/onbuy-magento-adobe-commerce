...
namespace M2E\OnBuy\Plugin\Config\Magento\Config\Model;
...
class Config extends \M2E\OnBuy\Plugin\AbstractPlugin
{
    ...
    /** @var \M2E\OnBuy\Model\Log\Clearing */
    private $logClearing;
    private \M2E\OnBuy\Model\Config\Manager $configManager;

    public function __construct(
        \M2E\OnBuy\Model\Config\Manager $configManager,
        \Magento\Framework\App\RequestInterface $request,
        \M2E\OnBuy\Helper\Module\Maintenance $moduleMaintenanceHelper,
        \M2E\OnBuy\Model\Module\Configuration $moduleConfigurationHelper,
        \M2E\OnBuy\Model\Log\Clearing $logClearing
    ) {
    ...
    private function processLogsClearingSection(array $groups): void
    {
        $this->logClearing->saveSettings(
            \M2E\OnBuy\Model\Log\Clearing::LOG_LISTINGS,
        ...
        $this->logClearing->saveSettings(
            \M2E\OnBuy\Model\Log\Clearing::LOG_ORDERS,
            (bool)(int)$groups['orders_logs_and_events_clearing']['fields']['orders_log_mode_field']['value'],
            90
        );
        $this->logClearing->saveSettings(
            \M2E\OnBuy\Model\Log\Clearing::LOG_SYNCHRONIZATIONS,
