...
namespace M2E\OnBuy\Model\ControlPanel\Widget;
...
class CronInfo implements \M2E\Core\Model\ControlPanel\Widget\CronInfoInterface
{
    ...
    {
        return $this->cronConfig->getActiveRunner() === \M2E\OnBuy\Model\Cron\Config::RUNNER_MAGENTO;
    }
    ...
    {
        return $this->cronConfig->isRunnerDisabled(\M2E\OnBuy\Model\Cron\Config::RUNNER_MAGENTO);
    }
