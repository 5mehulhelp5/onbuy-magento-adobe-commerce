...
HTML
        ...
        if ($this->cronConfig->isRunnerDisabled(\M2E\OnBuy\Model\Cron\Config::RUNNER_MAGENTO)) {
            $message = sprintf('Cron [%s] is disabled by developer', \M2E\OnBuy\Model\Cron\Config::RUNNER_MAGENTO);
