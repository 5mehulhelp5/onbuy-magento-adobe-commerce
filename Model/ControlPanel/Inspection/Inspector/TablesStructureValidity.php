...
use M2E\OnBuy\Model\ControlPanel\Inspection\FixerInterface;
...
class TablesStructureValidity implements InspectorInterface, FixerInterface
{
    ...
    private function getDiff(): array
    {
        ...
        $command = new \M2E\OnBuy\Model\Connector\Command\System\Tables\GetDiffCommand($tablesInfo);
    ...
    private function renderMetadata($data): string
    {
        $currentUrl = $this->urlBuilder->getUrl(
            '*/controlPanel_tools_onbuy/install',
            ['action' => 'fixColumn']
        );
