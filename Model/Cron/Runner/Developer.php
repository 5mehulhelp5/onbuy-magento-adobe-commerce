...
namespace M2E\OnBuy\Model\Cron\Runner;

use M2E\OnBuy\Model\Cron\AbstractRunner;

class Developer extends AbstractRunner
{
    private array $allowedTasks;
    private \M2E\OnBuy\Model\Cron\TaskRepository $taskRepository;

    public function __construct(
        \M2E\OnBuy\Model\Cron\TaskRepository $taskRepository,
