...
abstract class AbstractTask
{
    ...
    private \M2E\OnBuy\Model\Synchronization\LogService $syncLogger;
    private \M2E\OnBuy\Model\Cron\Manager $cronManager;
    ...
    protected \M2E\OnBuy\Model\Lock\Item\Manager $lockItemManager;
    protected \M2E\OnBuy\Model\Cron\OperationHistory $operationHistory;
    protected \M2E\OnBuy\Model\Cron\OperationHistory $parentOperationHistory;
    protected \M2E\OnBuy\Model\Cron\TaskRepository $taskRepo;
    protected \M2E\OnBuy\Helper\Data $helperData;
    ...
    public function process(): void
    {
        ...
        try {
            $this->eventManager->dispatch(
                \M2E\OnBuy\Model\Cron\Strategy::PROGRESS_START_EVENT_NAME,
            ...
            $this->eventManager->dispatch(
                \M2E\OnBuy\Model\Cron\Strategy::PROGRESS_STOP_EVENT_NAME,
                ['progress_nick' => $this->getNick()]
            );
    ...
    /**
     * @param \M2E\OnBuy\Model\Lock\Item\Manager $lockItemManager
     *
     * @return $this
     */
    public function setLockItemManager(\M2E\OnBuy\Model\Lock\Item\Manager $lockItemManager)
    {
    ...
    /**
     * @return \M2E\OnBuy\Model\Lock\Item\Manager
     */
    ...
    /**
     * @param \M2E\OnBuy\Model\Cron\OperationHistory $object
     *
     * @return $this
     */
    public function setParentOperationHistory(\M2E\OnBuy\Model\Cron\OperationHistory $object)
    {
    ...
    private function initialize(): void
    {
        ...
        $exceptionHelper = \Magento\Framework\App\ObjectManager::getInstance()
                                                               ->get(\M2E\OnBuy\Helper\Module\Exception::class);
    ...
    protected function getOperationHistory(): \M2E\OnBuy\Model\Cron\OperationHistory
    {
    ...
    /**
     * @return \M2E\OnBuy\Model\Config\Manager
     */
    protected function getConfig(): \M2E\OnBuy\Model\Config\Manager
    {
        /** @var \M2E\OnBuy\Model\Config\Manager */
        return \Magento\Framework\App\ObjectManager::getInstance()->get(\M2E\OnBuy\Model\Config\Manager::class);
    }
