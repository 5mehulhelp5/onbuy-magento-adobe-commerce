...
class DetectSpecialPriceEndDateTask extends \M2E\OnBuy\Model\Cron\AbstractTask
{
    ...
    public function __construct(
        ...
        \M2E\OnBuy\PublicServices\Product\SqlChange $publicService,
    ...
    protected function performActions()
    {
        ...
        $collection->addFieldToFilter(
            \M2E\OnBuy\Model\ResourceModel\Product::COLUMN_MAGENTO_PRODUCT_ID,
    ...
    private function getCurrentPrice(\M2E\OnBuy\Model\Product $listingProduct): ?float
    {
    ...
    private function getAllStoreIds(): array
    {
        ...
        $collectionListing->getSelect()->columns([
            \M2E\OnBuy\Model\ResourceModel\Listing::COLUMN_STORE_ID
            => \M2E\OnBuy\Model\ResourceModel\Listing::COLUMN_STORE_ID,
        ]);
        $collectionListing->getSelect()->group(\M2E\OnBuy\Model\ResourceModel\Listing::COLUMN_STORE_ID);

        foreach ($collectionListing->getData() as $item) {
            $storeIds[] = $item[\M2E\OnBuy\Model\ResourceModel\Listing::COLUMN_STORE_ID];
        }
