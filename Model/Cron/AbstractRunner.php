...
abstract class AbstractRunner
{
    ...
    private \M2E\OnBuy\Model\Cron\OperationHistory $operationHistory;
    private \M2E\OnBuy\Model\Lock\Transactional\ManagerFactory $lockTransactionManagerFactory;
    ...
    private \M2E\OnBuy\Model\Cron\OperationHistoryFactory $operationHistoryFactory;
    private \M2E\OnBuy\Model\Cron\Strategy $strategy;
    private \M2E\Core\Helper\Client\MemoryLimit $memoryLimit;
    /** @var \M2E\OnBuy\Model\Cron\Config */
    ...
    public function __construct(
        ...
        \M2E\OnBuy\Model\Lock\Transactional\ManagerFactory $lockTransactionManagerFactory,
        ...
        \M2E\OnBuy\Model\Cron\Strategy $strategy
    ) {
    ...
    protected function getStrategy(): \M2E\OnBuy\Model\Cron\Strategy
    {
    ...
    public function getOperationHistory(): \M2E\OnBuy\Model\Cron\OperationHistory
    {
