...
class TrackingDetailsBuilder
{
    ...
    public function build(
        ...
        int $storeId
    ): ?\M2E\OnBuy\Model\Order\Shipment\Data\TrackingDetails {
    ...
    private function getItemsQty(\Magento\Sales\Model\Order\Shipment $shipment): array
    {
        $shipmentItemsQty = [];

        foreach ($shipment->getItems() as $shipmentItem) {
            $shipmentItemsQty[(int)$shipmentItem->getProductId()] = $shipmentItem->getQty();
        }

        return $shipmentItemsQty;
    }
}
