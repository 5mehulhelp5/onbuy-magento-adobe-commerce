...
class CreditMemo
{
    ...
    public function process(\M2E\OnBuy\Model\Order $order): ?\Magento\Sales\Model\Order\Creditmemo
    {
    ...
    private function canCreateCreditMemo(\M2E\OnBuy\Model\Order $order): bool
    {
