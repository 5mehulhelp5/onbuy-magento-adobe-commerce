...
class Repository
{
    private \M2E\OnBuy\Model\ResourceModel\Order\Log $resource;

    public function __construct(
        \M2E\OnBuy\Model\ResourceModel\Order\Log $resource
    ) {
        $this->resource = $resource;
    }

    public function save(\M2E\OnBuy\Model\Order\Log $orderLog)
    {
