...
{
    private \M2E\OnBuy\Model\Magento\Order\Shipment\TrackFactory $magentoOrderShipmentTrackFactory;

    public function __construct(
        \M2E\OnBuy\Model\Magento\Order\Shipment\TrackFactory $magentoOrderShipmentTrackFactory
    ) {
        $this->magentoOrderShipmentTrackFactory = $magentoOrderShipmentTrackFactory;
    }

    public function process(\M2E\OnBuy\Model\Order $order): void
    {
    ...
    private function canCreateTracks(\M2E\OnBuy\Model\Order $order): bool
    {
