...
namespace M2E\OnBuy\Model\MSI\Order;
...
class Reserve
{
    public const EVENT_TYPE_MAGENTO_RESERVATION_PLACED = 'onbuy_reservation_placed';
    public const EVENT_TYPE_MAGENTO_RESERVATION_RELEASED = 'onbuy_reservation_released';

    public const M2E_ORDER_OBJECT_TYPE = 'onbuy_order';
