...
use M2E\OnBuy\Model\ResourceModel;
...
class Buffer
{
    ...
    private \M2E\OnBuy\Model\Tag\Repository $tagRepository;
    private Repository $listingProductTagRepository;
    private \M2E\OnBuy\Model\Product\Repository $productRepository;
    private \M2E\OnBuy\Model\Tag\BlockingErrors $blockingErrors;

    public function __construct(
        \M2E\OnBuy\Model\Tag\Repository $tagRepository,
        ...
        \M2E\OnBuy\Model\Tag\BlockingErrors $blockingErrors
    ) {
    ...
    public function addTag(\M2E\OnBuy\Model\Product $listingProduct, \M2E\OnBuy\Model\Tag $tag): void
    {
     ...
     * @param \M2E\OnBuy\Model\Tag[] $tags
     *
     * @return void
     */
    public function addTags(\M2E\OnBuy\Model\Product $listingProduct, array $tags): void
    {
    ...
    public function removeAllTags(\M2E\OnBuy\Model\Product $listingProduct): void
    {
        $item = $this->getItem($listingProduct->getId());
    ...
    public function removeTagByCode(\M2E\OnBuy\Model\Product $product, string $code): void
    {
    ...
    /**
     * @return array<string, \M2E\OnBuy\Model\Tag\Entity>
     */
     ...
     * @param Buffer\Item[] $items
     *
     * @return array<int, <string, \M2E\OnBuy\Model\Tag\Entity>>
     */
    ...
    /**
     * @param \M2E\OnBuy\Model\Tag\ListingProduct\Buffer\Item[] $items
