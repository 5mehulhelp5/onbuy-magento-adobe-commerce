...
class Repository
{
    ...
    /** @var \M2E\OnBuy\Model\Tag\EntityFactory */
    private $entityFactory;

    private $isLoad = false;
    private $entitiesByErrorCode = [];
    private $entitiesById = [];
    /** @var \M2E\OnBuy\Model\Tag[] */
    private $tags;

    public function __construct(
        \M2E\OnBuy\Model\TagFactory $tagFactory,
        \M2E\OnBuy\Model\ResourceModel\Tag\CollectionFactory $collectionFactory,
    ...
    public function create(\M2E\OnBuy\Model\Tag $tag): void
    {
        if ($this->has($tag)) {
            return;
        }
    ...
    public function has(\M2E\OnBuy\Model\Tag $tag): bool
    {
        $this->load();
    ...
    public function findEntityById(int $id): ?\M2E\OnBuy\Model\Tag\Entity
    {
        $this->load();
    ...
    public function findTagByCode(string $code): ?\M2E\OnBuy\Model\Tag
    {
        $this->load();
