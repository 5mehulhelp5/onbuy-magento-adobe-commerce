...
namespace M2E\OnBuy\Model\Servicing;
...
class Dispatcher
{
    ...
    private \M2E\OnBuy\Model\Connector\Client\Single $serverConnector;

    public function __construct(
        \M2E\OnBuy\Helper\Module\Exception $helperException,
        \M2E\OnBuy\Model\Registry\Manager $registryManager,
        \Magento\Framework\ObjectManagerInterface $objectManager,
        \M2E\OnBuy\Model\Connector\Client\Single $serverConnector
    ) {
    ...
    private function processTasks(array $taskCodes): void
    {
        ...
        $command = new \M2E\OnBuy\Model\Connector\Command\ServicingCommand($requestData);
     ...
     *
     * @return \M2E\OnBuy\Model\Servicing\TaskInterface[]
     */
    ...
    private function getTaskModel(string $taskName): TaskInterface
    {
        ...
        /** @var \M2E\OnBuy\Model\Servicing\TaskInterface */
