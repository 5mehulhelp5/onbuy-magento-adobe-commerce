...
namespace M2E\OnBuy\Model\Magento\Product\Rule\Condition;
...
class Product extends AbstractModel
{
    ...
    private \M2E\OnBuy\Model\Magento\Product\Rule\Custom\CustomFilterFactory $customFilterFactory;
    ...
    public function __construct(
        ...
        \M2E\OnBuy\Model\Magento\Product\Rule\Custom\CustomFilterFactory $customFilterFactory,
    ...
    public function getValueElementRenderer()
    {
        ...
        return $this->_layout->getBlockSingleton(
            \M2E\OnBuy\Block\Adminhtml\Magento\Product\Rule\Renderer\Editable::class
        );
    }
    ...
    protected function _addSpecialAttributes(array &$attributes)
    {
        ...
        foreach ($this->getCustomFilters() as $customFilterClassName) {
            ...
            if ($customFilterInstance instanceof \M2E\OnBuy\Model\Magento\Product\Rule\Custom\AbstractCustomFilter) {
    ...
    {
        return [
            \M2E\OnBuy\Model\Magento\Product\Rule\Custom\Magento\Stock::NICK,
            \M2E\OnBuy\Model\Magento\Product\Rule\Custom\Magento\Qty::NICK,
            \M2E\OnBuy\Model\Magento\Product\Rule\Custom\Magento\TypeId::NICK,
            \M2E\OnBuy\Model\Magento\Product\Rule\Custom\OnBuy\OnlineTitle::NICK,
            \M2E\OnBuy\Model\Magento\Product\Rule\Custom\OnBuy\OnlineQty::NICK,
            \M2E\OnBuy\Model\Magento\Product\Rule\Custom\OnBuy\OnlinePrice::NICK,
            \M2E\OnBuy\Model\Magento\Product\Rule\Custom\OnBuy\Status::NICK,
        ];
    }
    ...
    /**
     * @return \M2E\OnBuy\Model\Magento\Product\Rule\Custom\AbstractCustomFilter
     * @throws \M2E\OnBuy\Model\Exception\Logic
     */
    protected function getCustomFilterInstance(
        string $filterType,
        bool $isReadyToCache = true
    ): ?\M2E\OnBuy\Model\Magento\Product\Rule\Custom\AbstractCustomFilter {
