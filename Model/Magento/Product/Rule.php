...
class Rule extends \M2E\OnBuy\Model\ActiveRecord\AbstractModel
{
    protected $_form;
    ...
    /** @var \M2E\OnBuy\Model\Magento\Product\Rule\Condition\CombineFactory */
    ...
    public function loadFromSerialized($serialized)
    {
        ...
        if ($prefix === null) {
            throw new \M2E\OnBuy\Model\Exception('Prefix must be specified before.');
        }
     ...
     * @return \M2E\OnBuy\Model\Magento\Product\Rule\Condition\Combine
     * @throws \M2E\OnBuy\Model\Exception
     */
    ...
    public function isEmpty()
    {
        ...
        foreach ($this->_conditions->getConditionModels() as $model) {
            if ($model instanceof \M2E\OnBuy\Model\Magento\Product\Rule\Condition\Product) {
    ...
    public function getConditionObj(): \M2E\OnBuy\Model\Magento\Product\Rule\Condition\AbstractModel
    {
     ...
     *                        ->createBlock('OnBuy/adminhtml_magento_product_rule')
