...
namespace M2E\OnBuy\Model\Magento\Tax\Rule;

class Builder
{
    public const TAX_CLASS_NAME_PRODUCT = 'M2E OnBuy Connect Product Tax Class';
    public const TAX_CLASS_NAME_CUSTOMER = 'M2E OnBuy Connect Customer Tax Class';
    public const TAX_CLASS_NAME_SHIPPING = 'M2E OnBuy Connect Shipping Tax Class';

    public const TAX_RATE_CODE_PRODUCT = 'M2E OnBuy Connect Tax Rate';
    public const TAX_RULE_CODE_PRODUCT = 'M2E OnBuy Connect Tax Rule';

    public const TAX_RATE_CODE_SHIPPING = 'M2E OnBuy Connect Shipping Tax Rate';
    public const TAX_RULE_CODE_SHIPPING = 'M2E OnBuy Connect Shipping Tax Rule';
