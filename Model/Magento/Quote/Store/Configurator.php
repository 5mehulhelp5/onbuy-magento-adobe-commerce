...
namespace M2E\OnBuy\Model\Magento\Quote\Store;
...
class Configurator
{
    ...
    private \M2E\OnBuy\Model\Magento\Tax\Rule\BuilderFactory $taxRuleFactory;

    public function __construct(
        \M2E\OnBuy\Model\Magento\Tax\Rule\BuilderFactory $taxRuleFactory,
        \M2E\OnBuy\Helper\Data\GlobalData $globalDataHelper,
        \M2E\OnBuy\Model\Magento\Config\Mutable $mutableConfig,
    ...
    public function getShippingTaxClassId()
    {
        ...
        if (
            ...
            return \M2E\OnBuy\Model\Magento\Product::TAX_CLASS_ID_NONE;
        }
