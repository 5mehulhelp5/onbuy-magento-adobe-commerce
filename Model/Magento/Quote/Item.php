...
use M2E\OnBuy\Model\Magento\Quote\Total\RoundTaxPercent;
...
class Item extends \Magento\Framework\DataObject
{
    ...
    private \M2E\OnBuy\Model\Magento\Tax\Helper $taxHelper;
    ...
    private \M2E\OnBuy\Model\Order\Item\ProxyObject $proxyItem;
    private \M2E\OnBuy\Model\Magento\Tax\Rule\BuilderFactory $taxRuleBuilderFactory;
    private \M2E\OnBuy\Model\Magento\ProductFactory $ourMagentoProductFactory;

    public function __construct(
        \M2E\OnBuy\Model\Magento\Tax\Rule\BuilderFactory $taxRuleBuilderFactory,
        \M2E\OnBuy\Model\Magento\ProductFactory $ourMagentoProductFactory,
        \M2E\OnBuy\Model\Magento\Tax\Helper $taxHelper,
        \Magento\Catalog\Model\ProductFactory $productFactory,
        \Magento\Tax\Model\Calculation $calculation,
        \Magento\GiftMessage\Model\MessageFactory $messageFactory,
        \Magento\Quote\Model\Quote $quote,
        \M2E\OnBuy\Model\Order\Item\ProxyObject $proxyItem
    ) {
        parent::__construct();
    ...
    public function setTaxClassIntoProduct(
        ...
        if (
            ...
            return $product->setTaxClassId(\M2E\OnBuy\Model\Magento\Product::TAX_CLASS_ID_NONE);
        }
