...
namespace M2E\OnBuy\Model\Magento;

use M2E\OnBuy\Model\Magento\Product\Image;
use M2E\OnBuy\Model\Magento\Product\Inventory\Factory;
...
class Product
{
    ...
    /** @var \M2E\OnBuy\Model\Magento\Product\Variation */
    ...
    /** @var \M2E\OnBuy\Model\Magento\Product\ImageFactory */
    private Product\ImageFactory $imageFactory;
    /** @var \M2E\OnBuy\Model\Magento\Product\VariationFactory */
    private Product\VariationFactory $variationFactory;
    private \Magento\Framework\ImageFactory $magentoImageFactory;
    /** @var \M2E\OnBuy\Model\Magento\ProductFactory */
    private ProductFactory $m2eMagentoProductFactory;

    public function __construct(
        \M2E\OnBuy\Model\Magento\ProductFactory $m2eMagentoProductFactory,
        ...
        \M2E\OnBuy\Model\Magento\Product\Type\ConfigurableFactory $configurableFactory,
        \M2E\OnBuy\Model\Magento\Product\Status $productStatus,
        ...
        \M2E\OnBuy\Model\Magento\Product\ImageFactory $imageFactory,
        \M2E\OnBuy\Model\Magento\Product\VariationFactory $variationFactory,
        ?int $productId = null
    ) {
     ...
     *
     * @return \M2E\OnBuy\Model\Magento\Product | \M2E\OnBuy\Model\Magento\Product\Cache
    ...
    public function loadProduct($productId = null, $storeId = null)
    {
        ...
        if ($productId <= 0) {
            throw new \M2E\OnBuy\Model\Exception('The Product ID is not set.');
        }
     ...
     * @param int $productId
     *
     * @return \M2E\OnBuy\Model\Magento\Product
     */
    ...
    public function getProduct(): \Magento\Catalog\Model\Product
    {
        ...
        throw new \M2E\OnBuy\Model\Exception('Load instance first');
    }
