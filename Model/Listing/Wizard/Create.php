...
class Create
{
    ...
    /** @var \M2E\OnBuy\Model\Listing\Wizard\StepFactory */
    private StepFactory $stepFactory;
    /** @var \M2E\OnBuy\Model\Listing\Wizard\StepDeclarationCollectionFactory */
    private StepDeclarationCollectionFactory $stepDeclarationCollectionFactory;
    /** @var \M2E\OnBuy\Model\Listing\Wizard\DeleteService */
    private DeleteService $deleteService;

    public function __construct(
        Repository $wizardRepository,
        \M2E\OnBuy\Model\Listing\WizardFactory $wizardFactory,
        \M2E\OnBuy\Model\Listing\Wizard\StepFactory $stepFactory,
        StepDeclarationCollectionFactory $stepDeclarationCollectionFactory,
        \M2E\OnBuy\Model\Listing\Wizard\DeleteService $deleteService
    ) {
    ...
    public function process(\M2E\OnBuy\Model\Listing $listing, string $type): \M2E\OnBuy\Model\Listing\Wizard
    {
        \M2E\OnBuy\Model\Listing\Wizard::validateType($type);
