...
class Manager
{
    ...
    /** @var \M2E\OnBuy\Model\Listing\Wizard\StepDeclarationCollection */
    private StepDeclarationCollection $stepCollection;
    private \M2E\OnBuy\Model\Listing\Wizard\ProductFactory $productFactory;
    /** @var \M2E\OnBuy\Model\Listing\Wizard\Step\BackHandlerFactory */
    private Step\BackHandlerFactory $stepBackHandlerFactory;

    public function __construct(
        \M2E\OnBuy\Model\Listing\Wizard $wizard,
        \M2E\OnBuy\Model\Listing\Wizard\StepDeclarationCollection $stepCollection,
        \M2E\OnBuy\Model\Listing\Wizard\ProductFactory $productFactory,
        \M2E\OnBuy\Model\Listing\Wizard\Step\BackHandlerFactory $stepBackHandlerFactory,
    ...
    {
        return $this->getWizardType() === \M2E\OnBuy\Model\Listing\Wizard::TYPE_UNMANAGED;
    }
    ...
    /**
     * @param \M2E\OnBuy\Model\UnmanagedProduct $unmanagedProduct
     *
     * @return void
     */
    public function addUnmanagedProduct(\M2E\OnBuy\Model\UnmanagedProduct $unmanagedProduct): ?\M2E\OnBuy\Model\Listing\Wizard\Product
    {
     ...
     */
    public function findProductByMagentoId(int $magentoProductId): ?\M2E\OnBuy\Model\Listing\Wizard\Product
    {
     ...
     * @return \M2E\OnBuy\Model\Listing\Wizard\Product|null
     */
    public function findProductById(int $id): ?\M2E\OnBuy\Model\Listing\Wizard\Product
    {
