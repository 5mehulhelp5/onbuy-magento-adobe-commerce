...
namespace M2E\OnBuy\Model\Listing\Wizard\CategoryValidation;

class Validator
{
    /** @var \M2E\OnBuy\Model\Category\Attribute\ValidateMagentoProduct[] */
    ...
    private \M2E\OnBuy\Model\Category\Attribute\ValidateMagentoProductFactory $validateMagentoProductFactory;

    public function __construct(
        \M2E\OnBuy\Model\Listing\Wizard\Manager $wizardManager,
        \M2E\OnBuy\Model\Listing\Wizard\Repository $wizardRepository,
        \M2E\OnBuy\Model\Category\Attribute\ValidateMagentoProductFactory $validateMagentoProductFactory
    ) {
    ...
    public function processChunk(int $productLimit): Result
    {
        ...
        foreach ($productToValidate as $product) {
            /** @var \M2E\OnBuy\Model\Category\Dictionary $categoryDictionary */
        ...
        return new \M2E\OnBuy\Model\Listing\Wizard\CategoryValidation\Result(
    ...
    private function getValidator(
        \M2E\OnBuy\Model\Category\Dictionary $categoryDictionary
    ): \M2E\OnBuy\Model\Category\Attribute\ValidateMagentoProduct {
