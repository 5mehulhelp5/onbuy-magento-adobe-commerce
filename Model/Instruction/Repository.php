...
class Repository
{
    ...
    public function create(\M2E\OnBuy\Model\Instruction $instruction): void
    {
        $instruction->save();
    }
    ...
    public function findListingProductIdsByPriority(int $limit, ?\DateTime $excludeUntil): array
    {
        ...
        $collection->getSelect()->where(sprintf('pl.%s IS NULL', \M2E\OnBuy\Model\ResourceModel\Product\Lock::COLUMN_ID));
