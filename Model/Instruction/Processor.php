...
namespace M2E\OnBuy\Model\Instruction;

class Processor
{
    private \M2E\OnBuy\Model\Config\Manager $configManager;
    private \M2E\OnBuy\Helper\Module\Exception $exceptionHelper;
    private \M2E\OnBuy\Model\Instruction\Handler\InputFactory $handlerInputFactory;
    ...
    public function __construct(
        ...
        \M2E\OnBuy\Model\Instruction\Handler\InputFactory $handlerInputFactory,
    ...
    /**
     * @param \M2E\OnBuy\Model\Product[] $listingsProductsById
     *
     * @return \M2E\OnBuy\Model\Instruction[][]
     */
