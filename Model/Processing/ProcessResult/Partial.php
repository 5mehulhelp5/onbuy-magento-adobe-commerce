...
namespace M2E\OnBuy\Model\Processing\ProcessResult;
...
class Partial
{
    ...
    private \M2E\OnBuy\Model\Processing\ResultHandlerFactory $resultHandlerFactory;
    private \M2E\OnBuy\Helper\Module\Exception $exceptionHelper;
    private \M2E\OnBuy\Model\Processing\LockManagerFactory $lockManagerFactory;

    public function __construct(
        \M2E\OnBuy\Model\Processing\Repository $repository,
        \M2E\OnBuy\Model\Processing\ResultHandlerFactory $resultHandlerFactory,
    ...
    public function processExpired(): void
    {
        foreach ($this->repository->findPartialTypeExpired() as $processing) {
            try {
                ...
                /** @var \M2E\OnBuy\Model\Processing\PartialResultHandlerInterface $handler */
