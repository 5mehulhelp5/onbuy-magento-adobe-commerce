...
use M2E\OnBuy\Model\ResourceModel\Processing\Lock as ProcessingLockResource;

class Repository
{
    private \M2E\OnBuy\Model\ResourceModel\Processing\Lock\CollectionFactory $collectionFactory;
    private \M2E\Core\Helper\Module\Database\Tables $tablesHelper;

    public function __construct(
        \M2E\OnBuy\Model\ResourceModel\Processing\Lock\CollectionFactory $collectionFactory,
    ...
    public function create(\M2E\OnBuy\Model\Processing\Lock $lock): void
    {
        $lock->save();
    }

    public function remove(\M2E\OnBuy\Model\Processing\Lock $lock): void
    {
        $lock->delete();
    }
     ...
     * @param int $objId
     *
     * @return \M2E\OnBuy\Model\Processing\Lock[]
     */
    ...
    public function findByProcessingAndNickAndId(
        \M2E\OnBuy\Model\Processing $processing,
        string $objNick,
        int $objId
    ): ?\M2E\OnBuy\Model\Processing\Lock {
        $collection = $this->collectionFactory->create();
        $collection
        ...
        /** @var \M2E\OnBuy\Model\Processing\Lock $lock */
    ...
    public function removeAllByProcessing(\M2E\OnBuy\Model\Processing $processing): void
    {
        $collection = $this->collectionFactory->create();
