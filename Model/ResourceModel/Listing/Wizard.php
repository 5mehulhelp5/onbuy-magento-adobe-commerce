...
class Wizard extends \M2E\OnBuy\Model\ResourceModel\ActiveRecord\AbstractModel
{
    ...
    {
        $this->_init(\M2E\OnBuy\Helper\Module\Database\Tables::TABLE_NAME_LISTING_WIZARD, self::COLUMN_ID);
    }
}
