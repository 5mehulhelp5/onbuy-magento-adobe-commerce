...
class Step extends \M2E\OnBuy\Model\ResourceModel\ActiveRecord\AbstractModel
{
    ...
    {
        $this->_init(\M2E\OnBuy\Helper\Module\Database\Tables::TABLE_NAME_LISTING_WIZARD_STEP, self::COLUMN_ID);
    }
}
