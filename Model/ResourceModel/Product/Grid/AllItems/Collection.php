...
namespace M2E\OnBuy\Model\ResourceModel\Product\Grid\AllItems;
...
use M2E\OnBuy\Model\ResourceModel\Tag\ListingProduct\Relation as TagProductRelationResource;
use M2E\OnBuy\Model\ResourceModel\Tag as TagResource;
...
class Collection extends \Magento\Framework\Data\Collection implements SearchResultInterface
{
    ...
    /** @var \M2E\OnBuy\Model\ResourceModel\Listing */
    private ListingResource $listingResource;
    /** @var \M2E\OnBuy\Model\ResourceModel\Account */
    ...
    private \M2E\OnBuy\Model\ResourceModel\Tag\ListingProduct\Relation $tagProductRelationResource;
    ...
    private function prepareCollection(): void
    {
        ...
        $this->wrappedCollection->joinTable(
            ...
            sprintf('%s = listing_%s', SiteResource::COLUMN_ID, ListingResource::COLUMN_SITE_ID),
            [
                'site_' . SiteResource::COLUMN_NAME => SiteResource::COLUMN_NAME,
    ...
    public function addFieldToFilter($field, $condition)
    {
        ...
        if ($field === 'site_id') {
            $field = 'site_' . SiteResource::COLUMN_SITE_ID;
        }
