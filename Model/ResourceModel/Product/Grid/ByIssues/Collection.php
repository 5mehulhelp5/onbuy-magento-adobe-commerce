...
namespace M2E\OnBuy\Model\ResourceModel\Product\Grid\ByIssues;
...
class Collection extends \M2E\OnBuy\Model\ResourceModel\ActiveRecord\Collection\AbstractModel implements SearchResultInterface
{
    ...
    private \M2E\OnBuy\Model\ResourceModel\Product\CollectionFactory $productCollectionFactory;
    private ListingResource $listingResource;

    public function __construct(
        TagResource $tagResource,
        ProductResource $productResource,
        \M2E\OnBuy\Model\ResourceModel\Product\CollectionFactory $productCollectionFactory,
