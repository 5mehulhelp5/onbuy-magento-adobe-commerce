...
class Description extends \M2E\OnBuy\Model\ResourceModel\ActiveRecord\AbstractModel
{
    ...
    {
        $this->_init(
            \M2E\OnBuy\Helper\Module\Database\Tables::TABLE_NAME_TEMPLATE_DESCRIPTION,
            self::COLUMN_ID
        );
    }
}
