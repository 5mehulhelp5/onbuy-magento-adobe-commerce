...
class Attribute extends \M2E\OnBuy\Model\ResourceModel\ActiveRecord\AbstractModel
{
    ...
    {
        $this->_init(
            \M2E\OnBuy\Helper\Module\Database\Tables::TABLE_NAME_TEMPLATE_CATEGORY_ATTRIBUTES,
            self::COLUMN_ID
        );
    }
}
