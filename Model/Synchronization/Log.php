...
namespace M2E\OnBuy\Model\Synchronization;

use M2E\OnBuy\Model\ResourceModel\Synchronization\Log as SyncLogResource;
...
class Log extends \M2E\OnBuy\Model\Log\AbstractModel
{
    ...
    public const _TASK_LISTINGS = 'M2E OnBuy Connect Listings';
    ...
    {
        parent::_construct();
        $this->_init(\M2E\OnBuy\Model\ResourceModel\Synchronization\Log::class);
    }
