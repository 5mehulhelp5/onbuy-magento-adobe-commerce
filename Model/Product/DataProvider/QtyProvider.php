...
use M2E\OnBuy\Model\Magento\Product as MagentoProduct;
...
class QtyProvider implements DataBuilderInterface
{
    ...
    private \M2E\OnBuy\Model\Product\QtyCalculatorFactory $qtyCalculatorFactory;

    public function __construct(\M2E\OnBuy\Model\Product\QtyCalculatorFactory $qtyCalculatorFactory)
    {
        $this->qtyCalculatorFactory = $qtyCalculatorFactory;
    }

    public function getQty(\M2E\OnBuy\Model\Product $product): int
    {
    ...
    protected function checkQtyWarnings(\M2E\OnBuy\Model\Product $product): void
    {
        $qtyMode = $product->getSellingFormatTemplate()->getQtyMode();
        if (
            $qtyMode === \M2E\OnBuy\Model\Policy\SellingFormat::QTY_MODE_PRODUCT_FIXED
            || $qtyMode === \M2E\OnBuy\Model\Policy\SellingFormat::QTY_MODE_PRODUCT
        ) {
