...
namespace M2E\OnBuy\Model\Product\Description;
...
class TemplateParser
{
    ...
    public function parseTemplate($text, \M2E\OnBuy\Model\Magento\Product $magentoProduct): string
    {
    ...
    private function insertAttributes($text, \M2E\OnBuy\Model\Magento\Product $magentoProduct): string
    {
