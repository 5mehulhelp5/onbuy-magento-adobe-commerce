...
use M2E\OnBuy\Model\Magento\Product\Cache;
...
class PriceCalculator
{
    ...
    private array $sourceModeMapping = [
        self::MODE_NONE => \M2E\OnBuy\Model\Policy\SellingFormat::PRICE_MODE_NONE,
        self::MODE_PRODUCT => \M2E\OnBuy\Model\Policy\SellingFormat::PRICE_MODE_PRODUCT,
        self::MODE_SPECIAL => \M2E\OnBuy\Model\Policy\SellingFormat::PRICE_MODE_SPECIAL,
        self::MODE_ATTRIBUTE => \M2E\OnBuy\Model\Policy\SellingFormat::PRICE_MODE_ATTRIBUTE,
        self::MODE_TIER => \M2E\OnBuy\Model\Policy\SellingFormat::PRICE_MODE_TIER,
    ];
    ...
    /** @var array */
    private $modifier = [];
    /** @var \M2E\OnBuy\Model\Magento\Product\Cache|null */
    ...
    private \M2E\OnBuy\Helper\Magento\Attribute $attributeHelper;
    ...
    public function __construct(
        ...
        \M2E\OnBuy\Helper\Magento\Attribute $attributeHelper
    ) {
    ...
    private function getSourceMode()
    {
        if (!in_array($this->getSource('mode'), $this->sourceModeMapping)) {
            throw new \M2E\OnBuy\Model\Exception\Logic('Unknown source mode.');
        }
    ...
    /**
     * @param \M2E\OnBuy\Model\Magento\Product\Cache|null $attributeSourceProduct
     *
     * @return \M2E\OnBuy\Model\Product\PriceCalculator
     */
    ...
    /**
     * @return \M2E\OnBuy\Model\Magento\Product\Cache|null
     */
    ...
    /**
     * @param \M2E\OnBuy\Model\Magento\Product $product
     *
     * @return double
    ...
    private function getGroupedTierValue(\M2E\OnBuy\Model\Magento\Product $product)
    {
    ...
    private function getBundleTierFixedValue(\M2E\OnBuy\Model\Magento\Product $product)
    {
        return $this->calculateBundleTierValue($product, $product->getPrice());
    }

    private function getBundleTierDynamicValue(\M2E\OnBuy\Model\Magento\Product $product)
    {
