...
{
    private \M2E\OnBuy\Model\Product\Action\Type\Delete\Request $request;
    ...
    {
        return \M2E\OnBuy\Model\Product\Action\Async\DefinitionsCollection::ACTION_DELETE;
    }
    ...
    protected function getCommand(): \M2E\Core\Model\Connector\CommandProcessingInterface
    {
        ...
        return new \M2E\OnBuy\Model\Channel\Connector\Product\DeleteCommand(
    ...
    private function getRequest(): \M2E\OnBuy\Model\Product\Action\Type\Delete\Request
    {
        /** @psalm-suppress RedundantPropertyInitializationCheck */
