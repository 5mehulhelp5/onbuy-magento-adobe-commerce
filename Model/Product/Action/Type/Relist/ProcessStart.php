...
{
    private \M2E\OnBuy\Model\Product\Action\Type\Relist\Request $request;
    ...
    {
        return \M2E\OnBuy\Model\Product\Action\Async\DefinitionsCollection::ACTION_RELIST;
    }
    ...
    protected function getCommand(): \M2E\Core\Model\Connector\CommandProcessingInterface
    {
        ...
        return new \M2E\OnBuy\Model\Channel\Connector\Product\RelistCommand(
    ...
    private function getRequest(): \M2E\OnBuy\Model\Product\Action\Type\Relist\Request
    {
        /** @psalm-suppress RedundantPropertyInitializationCheck */
