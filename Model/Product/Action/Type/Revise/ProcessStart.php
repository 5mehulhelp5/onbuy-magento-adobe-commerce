...
{
    private \M2E\OnBuy\Model\Product\Action\Type\Revise\Request $request;
    ...
    {
        return \M2E\OnBuy\Model\Product\Action\Async\DefinitionsCollection::ACTION_REVISE;
    }
    ...
    protected function getCommand(): \M2E\Core\Model\Connector\CommandProcessingInterface
    {
        ...
        return new \M2E\OnBuy\Model\Channel\Connector\Product\ReviseCommand(
    ...
    private function getRequest(): \M2E\OnBuy\Model\Product\Action\Type\Revise\Request
    {
        /** @psalm-suppress RedundantPropertyInitializationCheck */
