...
namespace M2E\OnBuy\Model\Product\Action\Manual;

abstract class AbstractManual
{
    private int $logsActionId;
    private \M2E\OnBuy\Model\Product\ActionCalculator $calculator;
    ...
    /**
     * @param \M2E\OnBuy\Model\Product[] $listingsProducts
     *
     * @return array
     */
    ...
    /**
     * @param \M2E\OnBuy\Model\Product\Action[] $actions
     * @param array $params
     *
     * @return Result
     */
