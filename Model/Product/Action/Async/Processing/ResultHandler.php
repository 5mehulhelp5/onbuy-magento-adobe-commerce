...
namespace M2E\OnBuy\Model\Product\Action\Async\Processing;

class ResultHandler implements \M2E\OnBuy\Model\Processing\SingleResultHandlerInterface
{
    public const NICK = 'product_action_async';

    private \M2E\OnBuy\Model\Product\Repository $listingProductRepository;
    private \M2E\OnBuy\Model\Product\Action\ProcessorAsyncFactory $processorAsyncFactory;
    private \M2E\OnBuy\Model\Product\Action\ConfiguratorFactory $configuratorFactory;
    ...
    public function __construct(
        ...
        \M2E\OnBuy\Model\Product\Action\ProcessorAsyncFactory $processorAsyncFactory,
        \M2E\OnBuy\Model\Product\Action\ConfiguratorFactory $configuratorFactory
    ) {
