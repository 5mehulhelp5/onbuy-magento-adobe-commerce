...
class ProcessorAsyncFactory
{
    ...
    private \M2E\OnBuy\Model\Product\Action\Async\Factory $asyncActionFactory;
    private \M2E\OnBuy\Model\Product\LockManager $lockManager;
    private \M2E\OnBuy\Model\Processing\Runner $processingRunner;
    private \M2E\OnBuy\Model\Product\Action\Async\Processing\InitiatorFactory $initiatorFactory;
    private \M2E\OnBuy\Model\Product\Action\LogBufferFactory $logBufferFactory;

    public function __construct(
        LoggerFactory $loggerFactory,
        \M2E\OnBuy\Model\Product\Action\Async\Factory $asyncActionFactory,
        \M2E\OnBuy\Model\Product\LockManager $lockManager,
        \M2E\OnBuy\Model\Processing\Runner $processingRunner,
        \M2E\OnBuy\Model\Product\Action\Async\Processing\InitiatorFactory $initiatorFactory,
    ...
    private function getInitiatorByChanger(int $statusChanger): int
    {
        switch ($statusChanger) {
            case \M2E\OnBuy\Model\Product::STATUS_CHANGER_UNKNOWN:
                return \M2E\Core\Helper\Data::INITIATOR_UNKNOWN;
            case \M2E\OnBuy\Model\Product::STATUS_CHANGER_USER:
