...
namespace M2E\OnBuy\Model\Product\Ui;
...
class RuntimeStorage
{
    ...
    public function __construct(\M2E\OnBuy\Model\Product\Repository $repository)
    {
    ...
    public function findProduct(int $id): ?\M2E\OnBuy\Model\Product
    {
