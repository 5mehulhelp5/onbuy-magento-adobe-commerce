...
namespace M2E\OnBuy\Model\Template;

class Category extends \M2E\OnBuy\Model\ActiveRecord\AbstractModel
{
    public const CATEGORY_MODE_NONE = 0;
    public const CATEGORY_MODE_ONBUY = 1;
    ...
    public const VALUE_MODE_ONBUY_RECOMMENDED = 1;
    ...
    public const RENDER_TYPE_SELECT_MULTIPLE = 'select_multiple';//TODO: will remove
    ...
    {
        parent::_construct();
        $this->_init(\M2E\OnBuy\Model\ResourceModel\Category\Dictionary::class);
    }
    ...
    {
        $this->cache->removeTagValues('onbuy_template_category');
