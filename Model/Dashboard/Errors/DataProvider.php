...
{
    use \M2E\OnBuy\Model\Dashboard\CacheIntValueTrait;

    private const CACHE_LIFE_TIME = 600; // 10 min

    private \M2E\OnBuy\Model\Listing\Log\Repository $logRepository;
    private \M2E\Core\Model\Dashboard\DateRangeFactory $dateRangeFactory;

    public function __construct(
        \M2E\OnBuy\Model\Listing\Log\Repository $logRepository,
