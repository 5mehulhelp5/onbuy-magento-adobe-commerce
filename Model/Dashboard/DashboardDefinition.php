...
{
    private const NAME = 'm2e_onbuy';
    private const TITLE = 'M2E OnBuy';

    private \M2E\OnBuy\Model\Dashboard\Shipments\DefinitionFactory $shipmentDefinitionFactory;
    private \M2E\OnBuy\Model\Dashboard\Shipments\Definition $shipmentDefinition;
    private \M2E\OnBuy\Model\Dashboard\Errors\DefinitionFactory $errorsDefinitionFactory;
    private \M2E\OnBuy\Model\Dashboard\Errors\Definition $errorsDefinition;
    private \M2E\OnBuy\Model\Dashboard\ProductIssues\DefinitionFactory $productIssuesDefinitionFactory;
    private \M2E\OnBuy\Model\Dashboard\ProductIssues\Definition $productIssuesDefinition;
    private \M2E\OnBuy\Model\Dashboard\Products\DefinitionFactory $productsDefinitionFactory;
    private \M2E\OnBuy\Model\Dashboard\Products\Definition $productsDefinition;
    private \M2E\OnBuy\Model\Dashboard\Sales\DefinitionFactory $salesDefinitionFactory;
    private \M2E\OnBuy\Model\Dashboard\Sales\Definition $salesDefinition;

    public function __construct(
        \M2E\OnBuy\Model\Dashboard\Shipments\DefinitionFactory $shipmentDefinitionFactory,
        \M2E\OnBuy\Model\Dashboard\Errors\DefinitionFactory $errorsDefinitionFactory,
        \M2E\OnBuy\Model\Dashboard\ProductIssues\DefinitionFactory $productIssuesDefinitionFactory,
        \M2E\OnBuy\Model\Dashboard\Products\DefinitionFactory $productsDefinitionFactory,
        \M2E\OnBuy\Model\Dashboard\Sales\DefinitionFactory $salesDefinitionFactory
    ) {
