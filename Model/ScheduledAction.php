...
class ScheduledAction extends \M2E\OnBuy\Model\ActiveRecord\AbstractModel
{
    ...
    {
        if ($this->isObjectNew()) {
            throw new \M2E\OnBuy\Model\Exception\Logic('Model must be loaded.');
        }
    ...
    {
        return $this->getActionType() === \M2E\OnBuy\Model\Product::ACTION_LIST;
    }

    public function isActionTypeRelist(): bool
    {
        return $this->getActionType() === \M2E\OnBuy\Model\Product::ACTION_RELIST;
    }

    public function isActionTypeRevise(): bool
    {
        return $this->getActionType() === \M2E\OnBuy\Model\Product::ACTION_REVISE;
    }

    public function isActionTypeStop(): bool
    {
        return $this->getActionType() === \M2E\OnBuy\Model\Product::ACTION_STOP;
    }

    public function isActionTypeDelete(): bool
    {
        return $this->getActionType() === \M2E\OnBuy\Model\Product::ACTION_DELETE;
    }
    ...
    private function validateStatusChanger(int $changer): void
    {
        $allowed = [
            ...
            \M2E\OnBuy\Model\Product::STATUS_CHANGER_COMPONENT,
            \M2E\OnBuy\Model\Product::STATUS_CHANGER_OBSERVER,
        ];
