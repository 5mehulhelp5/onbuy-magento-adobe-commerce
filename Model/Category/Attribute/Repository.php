...
use M2E\OnBuy\Model\ResourceModel\Category\Attribute as AttributeResource;

class Repository
{
    private \M2E\OnBuy\Model\ResourceModel\Category\Attribute\CollectionFactory $attributeCollectionFactory;
    private AttributeResource $attributeResource;

    public function __construct(
        \M2E\OnBuy\Model\ResourceModel\Category\Attribute\CollectionFactory $attributeCollectionFactory,
    ...
    public function getAttributesWithCustomValue(int $dictionaryId): array
    {
        ...
        $collection->addFieldToFilter(
            AttributeResource::COLUMN_ATTRIBUTE_TYPE,
            ['in' => [CategoryAttribute::ATTRIBUTE_TYPE_PRODUCT, CategoryAttribute::ATTRIBUTE_TYPE_BRAND]]
        );
