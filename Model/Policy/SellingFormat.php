...
class SellingFormat extends \M2E\OnBuy\Model\ActiveRecord\AbstractModel implements PolicyInterface
{
    ...
    /** @var \M2E\OnBuy\Model\Policy\SellingFormat\Source[] */
    ...
    public function __construct(
        ...
        \M2E\OnBuy\Model\Policy\SellingFormat\SourceFactory $sourceFactory,
    ...
    public function isLocked(): bool
    {
        return (bool)$this
            ...
            ->create()
            ->addFieldToFilter(
                \M2E\OnBuy\Model\ResourceModel\Listing::COLUMN_TEMPLATE_SELLING_FORMAT_ID,
                $this->getId()
            )
            ->getSize();
    }
