...
class Source
{
    ...
    private ?\M2E\OnBuy\Model\Policy\Description $descriptionTemplateModel = null;
    private ?\M2E\OnBuy\Model\Magento\Product\Image\Set $imagesSet = null;

    private \M2E\OnBuy\Model\Product\Description\TemplateParser $templateParser;
    private \Magento\Email\Model\Template\Filter $emailTemplateFilter;
    private \M2E\OnBuy\Model\Magento\Product\ImageFactory $magentoProductImageFactory;

    public function __construct(
        \M2E\OnBuy\Model\Product\Description\TemplateParser $templateParser,
        \Magento\Email\Model\Template\Filter $emailTemplateFilter,
        \M2E\OnBuy\Model\Magento\Product\ImageFactory $magentoProductImageFactory
    ) {
    ...
    public function setDescriptionPolicy(\M2E\OnBuy\Model\Policy\Description $instance): self
    {
    ...
    /**
     * @throws \M2E\OnBuy\Model\Exception|\Magento\Framework\Exception\FileSystemException
     */
    ...
    public function getImageSet(): \M2E\OnBuy\Model\Magento\Product\Image\Set
    {
        ...
        $set = new \M2E\OnBuy\Model\Magento\Product\Image\Set();
    ...
    public function getMainImage(): ?\M2E\OnBuy\Model\Magento\Product\Image
    {
        $image = null;
    ...
    /**
     * @return \M2E\OnBuy\Model\Magento\Product\Image[]
     */
