...
use M2E\OnBuy\Model\Policy\PolicyInterface;
use M2E\OnBuy\Model\ResourceModel\Policy\Description as DescriptionResource;

class Description extends \M2E\OnBuy\Model\ActiveRecord\AbstractModel implements PolicyInterface
{
    ...
    /** @var \M2E\OnBuy\Model\Policy\Description\Source[] */
    ...
    {
        parent::_construct();
        $this->_init(\M2E\OnBuy\Model\ResourceModel\Policy\Description::class);
    }
