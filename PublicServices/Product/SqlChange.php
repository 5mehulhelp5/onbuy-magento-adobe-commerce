...
/*
    ...
    $model = $this->_objectManager->create('\M2E\OnBuy\PublicServices\Product\SqlChange');

    // notify M2E OnBuy about some change of product with ID 17
    $model->markProductChanged(17);

    // make price change of product with ID 18 and then notify M2E OnBuy
    $model->markPriceWasChanged(18);

    // make QTY change of product with ID 19 and then notify M2E OnBuy
    $model->markQtyWasChanged(19);

    // make status change of product with ID 20 and then notify M2E OnBuy
...
use M2E\OnBuy\Model\ResourceModel\Instruction as InstructionResource;
...
class SqlChange
{
    ...
    /**
     * @return \M2E\OnBuy\PublicServices\Product\SqlChange
    ...
    public function markProductAttributeChanged(
        ...
        throw new \M2E\OnBuy\Model\Exception\Logic('Method is not supported.');
    }
