...
/*
    ...
    $model = $this->_objectManager->create('\M2E\OnBuy\PublicServices\Product\ObjectChange');
...
namespace M2E\OnBuy\PublicServices\Product;
...
class ObjectChange
{
    ...
    /** @var \M2E\OnBuy\Observer\Product\AddUpdate\BeforeFactory */
    private $observerProductSaveBeforeFactory;
    /** @var \M2E\OnBuy\Observer\Product\AddUpdate\AfterFactory */
    private $observerProductSaveAfterFactory;
    /** @var \M2E\OnBuy\Observer\StockItem\Save\BeforeFactory */
    private $observerStockItemSaveBeforeFactory;
    /** @var \M2E\OnBuy\Observer\StockItem\Save\AfterFactory */
    ...
    /** @var \M2E\OnBuy\PublicServices\Product\SqlChange */
    protected $sqlChange;
    ...
    public function __construct(
        ...
        \M2E\OnBuy\Observer\Product\AddUpdate\BeforeFactory $observerProductSaveBeforeFactory,
        \M2E\OnBuy\Observer\Product\AddUpdate\AfterFactory $observerProductSaveAfterFactory,
        \M2E\OnBuy\Observer\StockItem\Save\BeforeFactory $observerStockItemSaveBeforeFactory,
        \M2E\OnBuy\Observer\StockItem\Save\AfterFactory $observerStockItemSaveAfterFactory,
        SqlChange $sqlChange,
