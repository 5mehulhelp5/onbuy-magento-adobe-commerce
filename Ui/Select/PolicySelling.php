...
{
    private \M2E\OnBuy\Model\Policy\SellingFormat\Repository $repository;

    public function __construct(\M2E\OnBuy\Model\Policy\SellingFormat\Repository $repository)
    {
