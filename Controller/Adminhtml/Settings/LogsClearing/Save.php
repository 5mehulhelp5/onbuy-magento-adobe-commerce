...
namespace M2E\OnBuy\Controller\Adminhtml\Settings\LogsClearing;

class Save extends \M2E\OnBuy\Controller\Adminhtml\AbstractBase
{
    private \M2E\OnBuy\Model\Log\Clearing $clearing;

    public function __construct(\M2E\OnBuy\Model\Log\Clearing $clearing)
    {
        parent::__construct();
