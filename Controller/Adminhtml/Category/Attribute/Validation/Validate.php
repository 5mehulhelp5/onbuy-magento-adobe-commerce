...
class Validate extends \M2E\OnBuy\Controller\Adminhtml\AbstractCategory
{
    private const MAX_PRODUCT_COUNT_FOR_CATEGORY_VALIDATE = 100;

    private \M2E\OnBuy\Model\Product\Category\Attribute\ValidatorFactory $attributeValidatorFactory;
    private \Magento\Framework\Controller\Result\JsonFactory $jsonResultFactory;

    public function __construct(
        \M2E\OnBuy\Model\Product\Category\Attribute\ValidatorFactory $attributeValidatorFactory,
