...
class Index extends AbstractTemplate
{
    ...
    {
        /** @var \M2E\OnBuy\Block\Adminhtml\Mapping\Tabs $tabsBlock */
        $tabsBlock = $this->getLayout()->createBlock(
            \M2E\OnBuy\Block\Adminhtml\Mapping\Tabs::class,
        );
        ...
        $this->addContent($this->getLayout()->createBlock(\M2E\OnBuy\Block\Adminhtml\Mapping::class));
