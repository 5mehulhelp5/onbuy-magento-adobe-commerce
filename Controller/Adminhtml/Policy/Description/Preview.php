...
namespace M2E\OnBuy\Controller\Adminhtml\Policy\Description;

use M2E\OnBuy\Controller\Adminhtml\Policy\AbstractDescription;
use M2E\OnBuy\Model\ResourceModel\Listing as ListingResource;
use M2E\OnBuy\Model\ResourceModel\Product as ProductResource;
use M2E\OnBuy\Model\Policy\Description as TemplateDescription;

class Preview extends AbstractDescription
{
    private \M2E\OnBuy\Model\Product\Description\RendererFactory $rendererFactory;
    ...
    public function __construct(
        ...
        \M2E\OnBuy\Model\Product\Description\RendererFactory $rendererFactory,
    ...
    public function execute()
    {
        ...
        $previewBlock = $this->getLayout()
                             ->createBlock(
                                 \M2E\OnBuy\Block\Adminhtml\Template\Description\Preview::class,
                             )
                             ->setData([
    ...
    private function getDescription(
        ...
        \M2E\OnBuy\Model\Product $listingProduct = null
    ): string {
    ...
    private function getMagentoProductById($productId, $storeId): ?\M2E\OnBuy\Model\Magento\Product
    {
    ...
    private function getListingProductByMagentoProductId($productId, $storeId): ?\M2E\OnBuy\Model\Product
    {
