...
class GetRuleConditionChooserHtml extends \M2E\OnBuy\Controller\Adminhtml\AbstractGeneral
{
        ...
        switch ($request->getParam('attribute')) {
            case 'sku':
                $block = $this->getLayout()->createBlock(
                    \M2E\OnBuy\Block\Adminhtml\Magento\Product\Rule\Chooser\Sku::class,
