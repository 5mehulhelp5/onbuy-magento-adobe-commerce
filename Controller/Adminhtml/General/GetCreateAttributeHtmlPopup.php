...
class GetCreateAttributeHtmlPopup extends \M2E\OnBuy\Controller\Adminhtml\AbstractGeneral
{
    public function execute()
    {
        $post = $this->getRequest()->getPostValue();

        /** @var \M2E\OnBuy\Block\Adminhtml\General\CreateAttribute $block */
        $block = $this->getLayout()->createBlock(\M2E\OnBuy\Block\Adminhtml\General\CreateAttribute::class);
