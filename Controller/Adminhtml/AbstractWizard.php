...
abstract class AbstractWizard extends AbstractMain
{
    ...
    {
        $this->setStatus(\M2E\OnBuy\Helper\Module\Wizard::STATUS_COMPLETED);
    ...
    {
        return $this->getLayout()->createBlock(\M2E\OnBuy\Block\Adminhtml\Wizard\Congratulation::class);
    }
    ...
    protected function installationAction()
    {
        ...
        if ($this->isNotStarted()) {
            $this->setStatus(\M2E\OnBuy\Helper\Module\Wizard::STATUS_ACTIVE);
        }
    ...
    protected function getWizardHelper(): \M2E\OnBuy\Helper\Module\Wizard
    {
    ...
    protected function setWizardStatusCompleted()
    {
        ...
        $this->wizardHelper->setStatus(
            \M2E\OnBuy\Helper\View\OnBuy::WIZARD_INSTALLATION_NICK,
            \M2E\OnBuy\Helper\Module\Wizard::STATUS_COMPLETED
        );
    }
}
