...
class MoveToListing extends \M2E\OnBuy\Controller\Adminhtml\AbstractListing
{
    ...
    {
        $sessionKey = \M2E\OnBuy\Helper\View::MOVING_LISTING_PRODUCTS_SELECTED_SESSION_KEY;
