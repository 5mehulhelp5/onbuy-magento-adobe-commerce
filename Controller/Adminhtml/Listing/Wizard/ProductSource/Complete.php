...
class Complete extends \M2E\OnBuy\Controller\Adminhtml\AbstractListing implements HttpPostActionInterface
{
    ...
    public function execute()
    {
        ...
        $allowedSources = [
            \M2E\OnBuy\Block\Adminhtml\Listing\Wizard\ProductSourceSelect::MODE_PRODUCT,
            \M2E\OnBuy\Block\Adminhtml\Listing\Wizard\ProductSourceSelect::MODE_CATEGORY,
        ];
