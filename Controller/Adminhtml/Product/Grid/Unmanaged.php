...
class Unmanaged extends \M2E\OnBuy\Controller\Adminhtml\AbstractListing
{
    ...
    {
        $wizard = $this->wizardRepository->findNotCompletedWizardByType(\M2E\OnBuy\Model\Listing\Wizard::TYPE_UNMANAGED);
