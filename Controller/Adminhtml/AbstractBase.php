...
abstract class AbstractBase extends Action
{
    ...
    public const MESSAGE_IDENTIFIER = 'onbuy_messages';
    public const GLOBAL_MESSAGES_GROUP = 'onbuy_global_messages_group';
    ...
    protected \M2E\OnBuy\Block\Adminhtml\Magento\Renderer\CssRenderer $cssRenderer;
    ...
    {
        /** @var \M2E\OnBuy\Controller\Adminhtml\Context $context */
        $context = \Magento\Framework\App\ObjectManager::getInstance()->get(
            \M2E\OnBuy\Controller\Adminhtml\Context::class
        );
    ...
    public function dispatch(\Magento\Framework\App\RequestInterface $request)
    {
        ...
        try {
            ...
            /** @var \M2E\OnBuy\Model\Module\Environment $moduleEnv */
            $moduleEnv = $this->_objectManager->get(\M2E\OnBuy\Model\Module\Environment::class);
    ...
    {
        /** @var \M2E\OnBuy\Helper\Module\Maintenance $maintenanceModule */
        $maintenanceModule = $this->_objectManager->get(\M2E\OnBuy\Helper\Module\Maintenance::class);
    ...
    protected function addLeft(\Magento\Framework\View\Element\AbstractBlock $block)
    {
        if ($this->getLayoutType() != self::LAYOUT_TWO_COLUMNS) {
            throw new \M2E\OnBuy\Model\Exception\Logic('Add left can not be used for non two column layout');
        }
    ...
    {
        $this->getResultPage()->getConfig()->addPageAsset("M2E_OnBuy::css/$file");
    }
    ...
    protected function appendGeneralBlock()
    {
        ...
        if (!$this->getLayout()->hasElement('m2e.onbuy.general')) { // view/layout/m2e_onbuy_general_handler.xml
            $generalBlock = $this->getLayout()->createBlock(\M2E\OnBuy\Block\Adminhtml\General::class);
    ...
    protected function setPageHelpLink($link)
    {
        ...
        $helpLinkBlock = $this->getLayout()->createBlock(\M2E\OnBuy\Block\Adminhtml\PageHelpLink::class)->setData([
            'page_help_link' => $link,
        ]);

        $pageTitleBlock->setTitleClass('OnBuy-page-title');
        $pageTitleBlock->setChild('OnBuy.page.help.block', $helpLinkBlock);
    }
    ...
    protected function getViewHelper(): \M2E\OnBuy\Helper\View
    {
        return $this->_objectManager->get(\M2E\OnBuy\Helper\View::class);
    }
}
