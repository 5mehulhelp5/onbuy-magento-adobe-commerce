    ...
    public function execute()
    {
        ...
        foreach ($orderIds as $orderId) {
            ...
            foreach ($shipmentsCollection->getItems() as $shipment) {
                ...
                if ($result === \M2E\OnBuy\Model\Order\ShipmentService::HANDLE_RESULT_FAILED) {
                    $isFail = true;
                }
            }
        }
